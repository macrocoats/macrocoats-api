...
const DOCS: Array<{
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    body: {
      grade:       'Industrial Grade',
      description: 'CORRUCUT 500 is a fast-drying, dearomatized hydrocarbon-based corrosion preventive fluid formulated for temporary rust protection of ferrous and non-ferrous components. Applied by dip or spray, it deposits a thin semi-dry wax-reinforced protective film that displaces moisture, inhibits atmospheric corrosion, and dries tack-free — making it suitable for in-process handling, inter-stage transit, and medium-term storage.',
      sections: {
        features: [
          { head: 'Fast Drying',              body: 'Dearomatized hydrocarbon carrier evaporates rapidly, leaving a tack-free film within 20–30 minutes at ambient temperature' },
          { head: 'Wax-Reinforced Film',      body: 'Microcrystalline wax component builds a semi-dry, adhesive film with excellent mechanical resistance to handling and moisture' },
          { head: 'Water Displacing',         body: 'Polar additive system actively displaces moisture from metal surfaces, providing immediate corrosion protection' },
          { head: 'Multi-metal Compatible',   body: 'Suitable for mild steel, cast iron, alloy steel, copper, and non-ferrous substrates at standard application' },
        ],
        physicalProperties: [
          { property: 'Appearance',           value: 'Clear to pale amber liquid',  unit: '—',    method: 'Visual' },
          { property: 'Flash Point',          value: '> 62',                        unit: '°C',   method: 'ASTM D93' },
          { property: 'Density (25 °C)',      value: '0.76 – 0.83',                 unit: 'g/mL', method: 'ISO 2811' },
          { property: 'Viscosity (40 °C)',    value: '3 – 8',                       unit: 'cSt',  method: 'ASTM D445' },
          { property: 'Film Thickness',       value: '2 – 6',                       unit: 'μm',   method: 'Dry film gauge after dip + drain' },
          { property: 'Dry Time (ambient)',   value: '20 – 30',                     unit: 'min',  method: 'Tack-free by finger test' },
          { property: 'Water Displacement',   value: '> 99',                        unit: '%',    method: 'Internal IM-002' },
        ],
        composition: [
        ...
        application: [
          ...
          { step: '2', name: 'Apply CORRUCUT 500',       param: 'Dip or spray',                         value: 'Ensure uniform coverage; 15–30 s dip time' },
          { step: '3', name: 'Drain',                param: 'Vertical draining',                    value: '15–30 min' },
        ...
        performance: [
          ...
          { label: 'Humidity cabinet',        val: '≥ 500 h (ASTM D1748)' },
          { label: 'Water displacement',      val: '> 99 %' },
          { label: 'Dry time (ambient)',       val: '20–30 min, tack-free film' },
        ],
        safetyNote: 'Flammable liquid — keep away from ignition sources and heat. Ensure adequate ventilation during application. Refer to the current SDS (SDS-UCC-001) for full hazard information and PPE requirements.',
      },
    },
  },

  {
    ...
    body: {
      ...
      sections: {
        ...
        composition: {
          ingredients: [
            { name: 'Dearomatized hydrocarbon solvent',       description: 'Carrier and film vehicle — low-aromatic aliphatic hydrocarbon', percent: '—', ghsClass: 'Aspiration Hazard / Flammable', tagType: 'danger' },
            { name: 'Petroleum sulfonate / calcium sulfonate', description: 'Primary corrosion inhibitors — protective film on metal',        percent: '—', ghsClass: 'Irritant',                     tagType: 'warn'   },
            { name: 'Oil-soluble corrosion inhibitors',       description: 'Supplementary rust prevention additives',                        percent: '—', ghsClass: 'None',                         tagType: 'safe'   },
            { name: 'Microcrystalline wax',                   description: 'Film former — improves adhesion and film integrity',              percent: '—', ghsClass: 'None',                         tagType: 'safe'   },
            { name: 'Polar additives',                        description: 'Water displacement and adhesion promoter',                       percent: '—', ghsClass: 'None',                         tagType: 'safe'   },
            { name: 'Antioxidants',                           description: 'Product stability — prevents sludge and oxidative degradation',  percent: '—', ghsClass: 'None',                         tagType: 'safe'   },
          ],
          note: 'Exact formulation is proprietary. Functional ingredient descriptions are provided for safety and emergency purposes only.',
        },
        firstAid: {
          ...
          inhalation: 'Move to fresh air. If symptoms persist, seek medical attention.',
          ingestion:  'Do NOT induce vomiting — aspiration risk. Seek immediate medical attention.',
          warning:    '⚠ Do NOT induce vomiting — dearomatized hydrocarbons carry high aspiration risk into lungs.',
        },
        fireFighting: {
          flammability:       'Flammable liquid — flash point > 62 °C',
          extinguishingMedia: 'CO₂, dry powder, foam. Do NOT use water jet on burning liquid.',
          fireHazard:         'Thermal decomposition may generate CO, CO₂, and hydrocarbon vapours.',
          ppe:                'SCBA and full fire-resistant protective clothing.',
        },
        ...
        physical: [
          ...
          { key: 'Density',       val: '0.76 – 0.83 g/mL' },
          { key: 'Viscosity',     val: '3 – 8 cSt at 40 °C' },
          { key: 'Solubility',    val: 'Insoluble in water' },
          { key: 'Boiling Point', val: '> 150 °C' },
          { key: 'Vapour Pres.',  val: 'Low at ambient temperature' },
        ],

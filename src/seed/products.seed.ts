...
const DOCS: Array<{
    ...
    body: {
      ...
      sections: {
        features: [
          ...
          { head: 'Dearomatized Formulation',        body: 'Drastically lower aromatic content provides an improved workplace environment with minimal odor and enhanced operator comfort.' },
          { head: 'Thin Non-Staining Film',          body: 'Leaves a cohesive protective barrier that resists dust adhesion and eliminates staining on high-finish components.' },
          { head: 'Barium-Free Composition',         body: 'Formulated to meet stringent global environmental criteria, reducing chemical disposal hazards and overhead costs.' },
          { head: 'Flexible Application',            body: 'Optimized for use via immersion tanks, automated spray lines, or manual brush setups.' },
        ],
        physicalProperties: [
          { property: 'Appearance',                  value: 'Clear, pale amber fluid',                     unit: '—',      method: 'Visual' },
          { property: 'Density @ 29.5°C',            value: '0.76 – 0.83',                                 unit: 'g/mL',   method: 'ASTM D1298' },
          { property: 'Kinematic Viscosity @ 40°C',  value: '35.0 – 40.0',                                 unit: 'cSt',    method: 'ASTM D445' },
          { property: 'Flash Point (PMCC)',          value: '> 62',                                        unit: '°C',     method: 'ASTM D93' },
          { property: 'Protective Film Classification', value: 'Thin, non-sticky oil-waxy protective layer',  unit: '—',      method: 'Internal' },
          { property: 'Estimated Film Thickness',    value: '2.0 – 4.0',                                   unit: 'μm',     method: 'Micrometer' },
          { property: 'Theoretical Consumption Coverage', value: '40 – 55',                                unit: 'm²/L',   method: 'Calculated' },
          { property: 'Water Displacement Performance', value: 'Passes complete shedding verification',    unit: '—',      method: 'IS 1154' },
          { property: 'Indoor Protection Period',    value: '9 – 12',                                      unit: 'months', method: 'Environmental' },
          { property: 'Outdoor Covered Protection Period', value: '3 – 6',                                 unit: 'months', method: 'Environmental' },
        ],
        composition: [
          { name: 'Dearomatized hydrocarbon solvent', function: 'Carrier and fast-drying vehicle for inhibitor delivery',    percent: '—', compat: 'All metals' },
          { name: 'Petroleum / calcium sulfonate',    function: 'Primary corrosion inhibitors — polar film on metal surface', percent: '—', compat: 'Ferrous, non-ferrous' },
          { name: 'Oil-soluble corrosion inhibitors', function: 'Supplementary rust prevention package',                     percent: '—', compat: 'All metals' },
          { name: 'Microcrystalline wax',             function: 'Semi-dry protective film former; enhances adhesion',         percent: '—', compat: 'All metals' },
          { name: 'Polar additives',                  function: 'Water displacement and substrate adhesion promoter',         percent: '—', compat: 'All metals' },
          { name: 'Antioxidants',                     function: 'Product stability — prevents oxidative degradation',         percent: '—', compat: '—' },
        ],
        application: [
        ...
        performance: [
          { label: 'Salt spray resistance',   val: 'Exceptional (ASTM B117)' },
          { label: 'Indoor Protection',       val: '9–12 Months' },
...

  {
    ...
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'SDS-UCC-001 Rev 01 · Jun 2026',
      center: 'This Safety Data Sheet is provided in good faith based on current knowledge. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nGHS Rev 9 Compliant · Page 1 of 1',
    },
    body: {
      ...
      sections: {
        ...
        composition: {
          ingredients: [
            { name: 'Dearomatized hydrocarbon solvent',       description: 'Carrier & film vehicle',    percent: '60% – 90%', ghsClass: 'Asp. Tox. 1 / Flam. Liq. 3', tagType: 'danger' },
            { name: 'Petroleum / calcium sulfonate',          description: 'Primary rust inhibitor',    percent: '3% – 10%',  ghsClass: 'Skin Irrit. 2',              tagType: 'warn'   },
            { name: 'Oil-soluble corrosion inhibitors',       description: 'Film reinforcement',        percent: '2% – 8%',   ghsClass: 'Not Classified',             tagType: 'safe'   },
            { name: 'Microcrystalline wax',                   description: 'Adhesion promoter',        percent: '0% – 15%',  ghsClass: 'Not Classified',             tagType: 'safe'   },
            { name: 'Polar additives',                        description: 'Water displacement agent',  percent: '0.5% – 5%', ghsClass: 'Not Classified',             tagType: 'safe'   },
            { name: 'Antioxidants',                           description: 'Oxidative stabilizer',      percent: '0.1% – 1%', ghsClass: 'Not Classified',             tagType: 'safe'   },
          ],
        ...
        fireFighting: {
          flammability:       'Combustible / Flammable formulation (Flash Point > 62°C)',
        ...
        physical: [
          ...
          { key: 'Flash Point',      val: '> 62 °C (ASTM D93)' },
          { key: 'Relative Density', val: '0.76 – 0.83 g/mL' },
          { key: 'Kinematic Viscosity', val: '38 cSt @ 40 °C' },
        ...
        transport: 'Not strictly regulated for non-bulk local transit due to flash point parameters (> 62°C). For containerized global maritime shipments, handle under standard combustible classification parameters with leak-proof seals verified before vehicle dispatch.',
...

  {
    ...
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'FRM-UCC-001 Rev 01 · Jun 2026',
      center: 'CONFIDENTIAL — This formulation sheet is the proprietary information of Macro Coats Pvt Ltd. Unauthorised reproduction or disclosure is prohibited.',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      ...
      batchUnit:          'L',
      totalActivePercent: 98,
      overview: 'CORRUCUT 500 is a dearomatized hydrocarbon solvent-based corrosion preventive fluid formulated for fast-drying, temporary rust protection. The product delivers a thin, semi-dry wax-reinforced protective film via a combination of sulfonates, oil-soluble corrosion inhibitors, microcrystalline wax, and polar water-displacing additives dissolved in a low-aromatic hydrocarbon carrier.',
      composition: [
        { srNo: 1, name: 'Dearomatized Hydrocarbon Solvent (C9–C14)', casNo: '64742-47-8', baseQty: 75.0, unit: 'L',  percentWV: 75.0, function: 'Primary carrier and fast-drying vehicle — low aromatic content minimises odour and toxicity', density: 0.79, unitPrice: 70  },
        { srNo: 2, name: 'Petroleum Sulfonate (Sodium Salt)',         casNo: '68608-26-4', baseQty: 5.0,  unit: 'L',  percentWV: 5.0,  function: 'Primary corrosion inhibitor — forms polar, moisture-resistant film on metal surface',        density: 0.95, unitPrice: 120 },
        { srNo: 3, name: 'Calcium Sulfonate (Overbased)',             casNo: '61789-86-4', baseQty: 3.0,  unit: 'L',  percentWV: 3.0,  function: 'Secondary inhibitor — neutralises acidic corrosion products and enhances film durability',    density: 1.02, unitPrice: 185 },
        { srNo: 4, name: 'Oil-Soluble Corrosion Inhibitor (TOFA)',    casNo: '61790-12-3', baseQty: 4.0,  unit: 'L',  percentWV: 4.0,  function: 'Rust prevention additive — tall oil fatty acid derivative providing supplementary barrier',    density: 0.92, unitPrice: 150 },
        { srNo: 5, name: 'Microcrystalline Wax',                      casNo: '63231-60-7', baseQty: 8.0,  unit: 'kg', percentWV: 8.0,  function: 'Film former — produces semi-dry, tack-free protective layer; improves adhesion to substrate', density: 0.92, unitPrice: 95  },
        { srNo: 6, name: 'Polar Additive (Glycol Ether Ester)',       casNo: 'Mixture',    baseQty: 2.5,  unit: 'L',  percentWV: 2.5,  function: 'Water displacement and substrate adhesion promoter',                                         density: 0.97, unitPrice: 210 },
        { srNo: 7, name: 'Antioxidant (DBPC)',                        casNo: '128-37-0',   baseQty: 0.5,  unit: 'kg', percentWV: 0.5,  function: 'Oxidation inhibitor — prevents product degradation and sludge formation during storage',       density: 1.05, unitPrice: 480 },
      ],
      preparation: [
        ...
        { step: 2, title: 'Heat Carrier Solvent',    detail: 'Add 75 L of Dearomatized Hydrocarbon Solvent to a stainless steel mixing vessel. Warm gently to 50–60 °C with slow stirring.' },
        { step: 3, title: 'Melt and Blend Wax',     detail: 'Add 8 kg of Microcrystalline Wax to the heated solvent. Continue stirring at 60 °C until the wax is fully dissolved and the blend is clear and homogeneous.' },
        { step: 4, title: 'Add Sulfonates',          detail: 'Reduce temperature to 50 °C. Slowly add 5 L of Petroleum Sulfonate followed by 3 L of Calcium Sulfonate. Stir for 15 minutes after each addition.' },
        { step: 5, title: 'Add Corrosion Inhibitor', detail: 'Add 4 L of the oil-soluble corrosion inhibitor (TOFA) with continuous stirring at 50 °C until fully dispersed.' },
        { step: 6, title: 'Add Polar Additive',      detail: 'Add 2.5 L of the polar additive blend. Mix at 45 °C for 10 minutes.' },
        { step: 7, title: 'Add Antioxidant',         detail: 'Add 0.5 kg DBPC antioxidant. Mix at 45 °C for 5 minutes until fully dissolved.' },
        { step: 8, title: 'Cool and QC Check',       detail: 'Allow batch to cool to ambient. Verify appearance (clear to pale amber), viscosity (3–8 cSt at 40 °C per ASTM D445), and flash point (>62 °C per ASTM D93). Fill into labelled HDPE containers.' },
      ],
      operatingConditions: [
        { param: 'Application Method',      value: 'Dip or spray' },
        { param: 'Application Temperature', value: '15 – 40 °C (ambient, no heating required)' },
        { param: 'Film Thickness',          value: '2 – 6 µm (dry, after dip + drain)' },
        { param: 'Dry Time',                value: '20 – 30 min at ambient (tack-free)' },
        { param: 'Protection Period',       value: '3 – 9 months (indoor / covered storage)' },
      ],
      applications: {
        removes:    ['Surface moisture', 'Atmospheric oxygen exposure', 'Flash rust risk'],
...

  {
    ...
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'COA-UCC-001 Rev 01 · Jun 2026',
      center: 'CONFIDENTIAL — For authorised recipients only · Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India',
    },
    body: {
      batchNumber:    'UCC-20260609-001',
      batchSize:      '100 L',
      productionDate: '09 Jun 2026',
      expiryDate:     'Jun 2028',
      grade:          'Industrial Grade',
      ...
      tests: [
        { parameter: 'Appearance',                       method: 'Visual',              specification: 'Clear to pale amber liquid',          result: 'Clear, pale amber liquid',       status: 'Pass' },
        { parameter: 'Flash Point',                      method: 'ASTM D93',            specification: '> 62 °C',                             result: '65 °C',                          status: 'Pass' },
        { parameter: 'Specific Gravity (25 °C)',          method: 'ISO 2811',            specification: '0.76 – 0.83',                         result: '0.80',                           status: 'Pass' },
        { parameter: 'Kinematic Viscosity (40 °C)',      method: 'ASTM D445',           specification: '3 – 8 cSt',                           result: '5.2 cSt',                        status: 'Pass' },

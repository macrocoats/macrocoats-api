...
const DOCS: Array<{
...

  {
    ...
    body: {
      ...
      composition: [
        { srNo: 1, name: 'Citric Acid',          casNo: '77-92-9',    baseQty: 2.90,  unit: 'kg', percentWV: 2.90,  function: 'Chelating agent / mild passivation initiator',           density: null, unitPrice: 110  },
        { srNo: 2, name: 'Sodium Nitrite',        casNo: '7632-00-0',  baseQty: 5.10,  unit: 'kg', percentWV: 5.10,  function: 'Corrosion inhibitor / anodic passivation agent',          density: null, unitPrice: 65   },
        { srNo: 3, name: 'BTA (Benzotriazole)',   casNo: '95-14-7',    baseQty: 0.55,  unit: 'kg', percentWV: 0.55,  function: 'Copper corrosion inhibitor / film former',                density: null, unitPrice: 850  },
        { srNo: 4, name: 'Water (DI/RO)',         casNo: '7732-18-5',  baseQty: 91.45, unit: 'L',  percentWV: 91.45, function: 'Base medium / carrier',                                  density: 1.0,  unitPrice: 0.5  },
      ],
      preparation: [
        ...
        { step: 2, title: 'Water Charging',       detail: 'Add 80–85 L of DI/RO water to a clean HDPE mixing tank. Begin gentle agitation.' },
        { step: 3, title: 'Sodium Nitrite Addition', detail: 'Slowly add Sodium Nitrite (5.10 kg) to the water with continuous stirring until fully dissolved (~10 min). Solution may warm slightly.' },
        { step: 4, title: 'Citric Acid Addition', detail: 'Add Citric Acid (2.90 kg) with stirring until completely dissolved. Monitor pH — concentrate should read 3.5–5.0.' },
        { step: 5, title: 'BTA Addition',         detail: 'Add BTA/Benzotriazole (0.55 kg) with stirring. BTA may require 15–20 min to fully dissolve at ambient temperature; light warming to 35–40 °C accelerates dissolution.' },
        { step: 6, title: 'Top Up & Homogenise',  detail: 'Add remaining DI/RO water to bring total batch volume to exactly 100 L. Mix for 10 minutes to ensure full homogeneity.' },

...
const DOCS: Array<{
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    productKey: 'corroklean',
    docType:    'tds',
    docNumber:  'TDS-UCK-001',
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'TDS-UCK-001 Rev 01 · Jun 2026',
      center: 'This Technical Data Sheet is for guidance only. Performance figures are typical values obtained under controlled conditions. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      ...
      sections: {
        ...
        physicalProperties: [
          ...
          { property: 'pH (neat)',            value: '6.5 – 9.0',                 unit: '—',    method: 'pH electrode, 25 °C' },
          { property: 'Dry Time (ambient)',   value: '2 – 5',                     unit: 'min',  method: 'Evaporation to tack-free by visual' },
          { property: 'Miscibility',          value: 'Fully miscible with water', unit: '—',    method: '—' },
        ],
        composition: [
          { name: 'Fast-drying solvent',    function: 'Primary active — rapid degreasing, soil dissolution, and fast evaporation', percent: '—', compat: 'Most metals, glass, many plastics' },
          { name: 'DI Water',                       function: 'Carrier / diluent',                                                         percent: '—', compat: '—' },
          { name: 'Optional alkalinity modifier',   function: 'Trace pH adjustment — mild alkalinity boost when required',                 percent: '—', compat: 'All metals at working concentration' },
        ],
        application: [
          { step: '1', name: 'Prepare substrate',   param: 'Dry substrate, free from heavy deposits',   value: 'Remove bulk soils before cleaning' },
          { step: '2', name: 'Apply CORROKLEAN',    param: 'Dip or spray',                               value: 'Ensure full surface coverage' },
          { step: '3', name: 'Allow to evaporate',  param: 'Air dry at ambient temperature',             value: '2–5 min — surface tack-free' },
          { step: '4', name: 'Inspect surface',     param: 'Visual or wipe check',                       value: 'Surface should be clean and dry with no residue' },
          { step: '5', name: 'Next stage',          param: 'Inspection / bonding / coating as required', value: 'Proceed immediately after drying' },
        ],
        packaging: [
          { size: '5',  unit: 'L', type: 'HDPE can' },
          { size: '20', unit: 'L', type: 'HDPE jerrycan' },
        ],
        performance: [
          { label: 'Dry time (ambient, 25 °C)',  val: '2–5 min, tack-free' },
          { label: 'Residue on evaporation',     val: 'Nil' },
          { label: 'Oil removal (light oils)',   val: '> 99 % (Internal IM-001)' },
          { label: 'Flash rust after clean',     val: 'N/A — no aqueous rinse required' },
        ],
        safetyNote: 'Highly flammable liquid — keep away from ignition sources, heat, and open flames. Ensure adequate ventilation during application. Refer to the current SDS (SDS-UCK-001) for full hazard information and PPE requirements.',
      },
    },
  },

  {
    productKey: 'corroklean',
    docType:    'msds',
    docNumber:  'SDS-UCK-001',
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'SDS-UCK-001 Rev 01 · Jun 2026',
      center: 'This Safety Data Sheet is provided in good faith based on current knowledge. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nGHS Rev 9 Compliant · Page 1 of 1',
    },
    body: {
      ...
      sections: {
        ...
        hazards: {
          ...
          classifications: [
            { class: 'Flammable Liquid',      category: 'Cat 2',  tagType: 'danger' },
            { class: 'Eye Irritation',        category: 'Cat 2A', tagType: 'warn'   },
            { class: 'STOT Single Exposure',  category: 'Cat 3',  tagType: 'warn'   },
          ],
          hStatements: 'H225 — Highly flammable liquid and vapour. H319 — Causes serious eye irritation. H336 — May cause drowsiness or dizziness.',
          pStatements: 'P210 · P233 · P260 · P264 · P271 · P280 · P303+P361+P353 · P304+P340 · P305+P351+P338 · P370+P378',
        },
        composition: {
          ingredients: [
            { name: 'Fast-drying solvent',  description: 'Primary active solvent — degreasing, soil dissolution, and rapid evaporation', percent: '—', ghsClass: 'Flammable / Irritant',                     tagType: 'warn'   },
            { name: 'DI Water',                     description: 'Carrier / diluent',                                                            percent: '—', ghsClass: 'None',                                      tagType: 'safe'   },
            { name: 'Optional alkalinity modifier', description: 'Trace pH adjustment agent (optional) — mild alkalinity boost',                percent: '—', ghsClass: 'Irritant (trace; concentrated form only)', tagType: 'warn'   },
          ],
          note: 'Exact formulation is proprietary. Functional ingredient descriptions are provided for safety and emergency purposes only.',
        },
        firstAid: {
          eyes:       'Flush with water for ≥15 min, holding eyelids open. Remove contact lenses if easily removable. Seek medical attention if irritation or redness persists.',
          skin:       'Wash with soap and water. Remove contaminated clothing. No burns expected at normal concentrations; seek advice if irritation persists.',
          inhalation: 'Move to fresh air immediately. If symptoms (dizziness, headache, drowsiness) persist, seek medical attention.',
          ingestion:  'Rinse mouth with water. Do NOT induce vomiting. Seek medical attention. Call AIIMS Poison Control: 1800-11-6117.',
          warning:    '⚠ Vapours in confined spaces may cause CNS depression — ensure adequate ventilation at all times.',
        },
        fireFighting: {
        ...
        accidentalRelease: [
          'Eliminate all ignition sources immediately — highly flammable vapour',
          'Ventilate area thoroughly; prevent vapour accumulation below flash point',
          'Wear PPE (safety glasses, nitrile gloves, apron)',
          'Contain spill with inert absorbent material (sand, vermiculite)',
          'Prevent entry into drains, sewers, and waterways',
          'Collect absorbed material into sealed, labelled HDPE containers',
          'Dispose as spent solvent waste per CPCB Hazardous Waste Rules 2016',
        ],
        handling: {
          handling:     'Apply by dip or spray. Keep away from heat, sparks, open flames, hot surfaces, and all ignition sources. Use only in well-ventilated areas. Bond and earth containers during transfer to prevent static discharge.',
          storageTemp:  '5 °C – 30 °C; cool, dry, well-ventilated area; away from heat sources, direct sunlight, and ignition sources',
          containers:   'Sealed HDPE or steel containers; keep tightly closed when not in use; store away from oxidisers',
          segregation:  'Store separately from oxidising agents, strong acids, strong alkalis, and sources of ignition',
          shelfLife:    '24 months from date of manufacture in original sealed containers',
        },
        exposure: {
          ppeItems:    ['Safety Glasses', 'Nitrile Gloves', 'Apron', 'Closed-toe Shoes'],
          engineering: 'Exhaust ventilation essential during spray application. LEV at application point. Eyewash station within 10 s.',
        },
        physical: [
          { key: 'Appearance',       val: 'Clear, colourless liquid' },
          ...
          { key: 'Vapour Pressure',  val: '~30 mbar at 20 °C' },
          { key: 'Miscibility',      val: 'Fully miscible with water' },
          { key: 'Viscosity',        val: 'Low (water-like)' },
        ],
        stability: {
          stability:      'Stable under recommended storage conditions',
          avoid:          'Open flames, sparks, static discharge, strong oxidising agents, strong acids and alkalis',
          decomposition:  'Thermal decomposition produces CO, CO₂, and water vapour',
          polymerisation: 'Will not occur',
        },
        sections11to16: {
          'Skin / Eye': 'Mild irritant. Eye exposure causes serious irritation — flush immediately for ≥15 min. Repeated skin exposure may cause dryness.',
          CNS:          'H336 — vapours at elevated concentrations may cause headache, dizziness, and drowsiness (STOT SE Cat 3). Ensure adequate ventilation.',
          Disposal:     'Dispose as spent solvent waste. Do not discharge to municipal sewer without treatment. Per CPCB Hazardous Waste Rules 2016.',
          Regulatory:   'MSIHC Rules 1989 · Factories Act 1948 · Hazardous Waste Rules 2016 · GHS Rev 9',
          'Other Info': 'SDS Rev 01 issued Jun 2026. Next review: Jun 2028 or upon formulation change.',
        },
      },
    },
  },

  {
    productKey: 'corroklean',
    docType:    'formula',
    docNumber:  'FRM-UCK-001',
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'FRM-UCK-001 Rev 01 · Jun 2026',
      center: 'CONFIDENTIAL — This formulation sheet is the proprietary information of Macro Coats Pvt Ltd. Unauthorised reproduction or disclosure is prohibited.',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      ...
      referenceBatchSize: 100,
      batchUnit:          'L',
      totalActivePercent: 75,
      overview: 'CORROKLEAN is an IPA-based cleaner formulated with isopropyl alcohol as the primary active solvent, DI water as the carrier, and an optional trace of ammonium hydroxide for mild alkalinity enhancement. The product delivers fast-evaporating, residue-free cleaning suitable for metal and general surface degreasing.',
      composition: [
        { srNo: 1, name: 'Isopropyl Alcohol (IPA)',  casNo: '67-63-0',    baseQty: 75,    unit: 'L',  percentWV: 75,    function: 'Primary active solvent — rapid degreasing, oil dissolution, and fast drying', density: null, unitPrice: 95 },
        { srNo: 2, name: 'DI Water',                 casNo: '7732-18-5',  baseQty: null,  unit: 'L',  percentWV: null,  function: 'Carrier / diluent — balance to final volume',                              density: null, unitPrice: 0  },
        { srNo: 3, name: 'Ammonium Hydroxide (25%)', casNo: '1336-21-6',  baseQty: 0.075, unit: 'L',  percentWV: 0.075, function: 'Optional pH adjustment — mild alkalinity boost for enhanced soil removal',  density: null, unitPrice: 40 },
      ],
      preparation: [
        { step: 1, title: 'Charge IPA',               detail: 'Measure 75 L of Isopropyl Alcohol (IPA, industrial grade) and transfer to the mixing vessel. Ensure adequate ventilation — flammable vapour risk.' },
        { step: 2, title: 'Add DI Water',              detail: 'Slowly add DI water to reach 100 L total volume (approximately 24.9 L). Mix gently to avoid splashing.' },
        { step: 3, title: 'Add Ammonium Hydroxide',    detail: '(Optional) Add 75 mL of Ammonium Hydroxide (25%) with stirring. Use only if mild alkalinity boost is required for the specific application.' },
        { step: 4, title: 'Mix and Homogenise',        detail: 'Stir the blend for 5–10 minutes until uniform. The product is a clear, single-phase liquid.' },
        { step: 5, title: 'QC Check & Pack',           detail: 'Verify appearance (clear, colourless to very pale), odour (characteristic IPA), and — if NH₃ was added — pH (7.5–9.0). Fill into labelled sealed HDPE containers away from ignition sources.' },
      ],
      operatingConditions: [
        { param: 'Application Method',    value: 'Dip or spray' },
        { param: 'Use Concentration',     value: 'Ready-to-use (neat) or diluted 1:1 with DI water' },
        { param: 'Operating Temperature', value: 'Ambient (15 – 40 °C)' },
        { param: 'Contact Time',          value: '1 – 5 min (wipe / dip); as required (spray)' },
        { param: 'Drying',                value: 'Fast evaporation — air dry or wipe off' },
      ],
      applications: {
        removes:    ['Light oils and greases', 'Fingerprints', 'Flux residues', 'Ionic surface contaminants', 'General light soils'],
        usedBefore: ['Inspection / QC', 'Assembly bonding', 'Painting / coating', 'Precision cleaning stages'],
      },
    },
  },

  {
    ...
    body: {
      ...
      pCodes: [
        ...
        { code: 'P271',           text: 'Use only in well-ventilated areas' },
        { code: 'P280',           text: 'Wear eye protection and protective gloves' },
        { code: 'P304+P340',      text: 'If inhaled, remove to fresh air; keep at rest for breathing' },
        { code: 'P305+P351+P338', text: 'If in eyes, rinse cautiously with water for ≥15 min; remove contacts; continue rinsing' },
        { code: 'P370+P378',      text: 'In case of fire, use CO₂ or dry powder to extinguish' },
      ],
      firstAid: {
        skin:       'Wash with soap and water. Remove contaminated clothing. Seek advice if irritation persists.',
        eyes:       'Flush with water for ≥15 min. Seek medical attention if irritation or redness persists.',
        ingestion:  'Rinse mouth. Do NOT induce vomiting. Call 1800-11-6117 if unwell.',
        inhalation: 'Move to fresh air. Rest in position comfortable for breathing. Seek medical attention if symptoms persist.',
      },
      directions: [
        'Use neat or dilute 1:1 with DI water',
        'Apply by dip or spray at ambient temperature',
        'Allow to air-dry (2–5 min) — no rinsing needed',
        'Keep away from flames and ignition sources during application',
      ],
      storage:  ['Store at 5°C – 30°C; keep tightly sealed', 'Keep away from heat, sparks, and open flames', 'Keep away from children', 'Dispose as solvent waste per CPCB regulations'],
      products: ['CORROKLEAN'],
    },
  },

  {
    productKey: 'corroklean',
    docType:    'coa',
    docNumber:  'COA-UCK-001',
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'COA-UCK-001 Rev 01 · Jun 2026',
      center: 'CONFIDENTIAL — For authorised recipients only · Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India',
    },
    body: {
      batchNumber:    'UCK-20260610-001',
      batchSize:      '100 L',
      productionDate: '10 Jun 2026',
      expiryDate:     'Jun 2028',
      grade:          'Industrial Grade',
      appearance:     'Clear, colourless liquid',
      tests: [
        { parameter: 'Appearance',               method: 'Visual',           specification: 'Clear, colourless liquid',   result: 'Clear, colourless',       status: 'Pass' },
        { parameter: 'Odour',                    method: 'Organoleptic',     specification: 'Characteristic IPA/alcohol', result: 'Characteristic IPA',      status: 'Pass' },
        { parameter: 'IPA Content (% v/v)',      method: 'GC / Density',     specification: '70.0 – 80.0 %',             result: '75.2 %',                  status: 'Pass' },
        { parameter: 'Specific Gravity (25 °C)', method: 'ISO 2811',         specification: '0.85 – 0.90',               result: '0.874',                   status: 'Pass' },
        { parameter: 'Flash Point',              method: 'ASTM D56',         specification: '15 – 22 °C',                result: '17 °C',                   status: 'Pass' },
        { parameter: 'pH (neat, 25 °C)',         method: 'pH Electrode',     specification: '6.5 – 9.0',                 result: '7.2',                     status: 'Pass' },
        { parameter: 'Water Content (% v/v)',    method: 'Karl Fischer',     specification: '20.0 – 30.0 %',             result: '24.8 %',                  status: 'Pass' },
      ],
      statement: 'We hereby certify that the above batch of CORROKLEAN has been manufactured, tested, and inspected in accordance with our internal quality specifications. All parameters conform to the product specification and the product is approved for release.',
      approvals: {
        preparedBy: 'Quality Analyst — Macro Coats',
        reviewedBy: 'QC Manager — Macro Coats',
        approvedBy: 'Operations Head — Macro Coats',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    productKey: 'corrcut-100',
    docType:    'tds',
    docNumber:  'TDS-UCR-001',
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'TDS-UCR-001 Rev 01 · Jun 2026',
      center: 'This Technical Data Sheet is for guidance only. Performance figures are typical values obtained under controlled conditions. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      grade:       'Industrial Grade',
      description: 'CORRCUT 100 is a light-bodied, mineral oil-based rust preventive formulated for reliable corrosion protection of ferrous and non-ferrous components during in-process handling, inter-stage transit, and storage. Applied by dip or spray, it deposits a thin, tenacious film that suppresses atmospheric corrosion. Its balanced formulation of protective additives, mineral oil carrier, and light hydrocarbon solvent produces a dry-to-touch film with excellent surface adhesion and water-displacing action.',
      sections: {
        features: [
          { head: 'Mineral Oil-Based Protection',  body: 'Mineral oil carrier provides a robust, adherent film with superior protection durability versus solvent-only products' },
          { head: 'Water Displacing',              body: 'Functional additive system actively displaces moisture from metal surfaces for immediate protection' },
          { head: 'Dry-to-Touch Film',             body: 'Film dries to a non-tacky, handling-safe surface within 30–45 minutes at ambient temperature' },
          { head: 'Multi-metal Compatible',        body: 'Suitable for mild steel, cast iron, alloy steel, copper alloys, and non-ferrous substrates' },
        ],
        physicalProperties: [
          { property: 'Appearance',          value: 'Clear to pale amber liquid', unit: '—',    method: 'Visual' },
          { property: 'Flash Point',         value: '> 60',                       unit: '°C',   method: 'ASTM D93' },
          { property: 'Density (25 °C)',     value: '0.80 – 0.87',                unit: 'g/mL', method: 'ISO 2811' },
          { property: 'Viscosity (40 °C)',   value: '5 – 15',                     unit: 'cSt',  method: 'ASTM D445' },
          { property: 'Film Thickness',      value: '3 – 8',                      unit: 'μm',   method: 'Dry film gauge after dip + drain' },
          { property: 'Dry Time (ambient)',  value: '30 – 45',                    unit: 'min',  method: 'Non-tacky by finger test' },
          { property: 'Water Displacement',  value: '> 98',                       unit: '%',    method: 'Internal IM-002' },
        ],
        composition: [
          { name: 'Aliphatic hydrocarbon solvent',    function: 'Carrier and viscosity diluent — aids film deposition and penetration', percent: '—', compat: 'All metals' },
          { name: 'Mineral base oil',                 function: 'Primary film-forming base oil — provides body and protection durability', percent: '—', compat: 'All metals' },
          { name: 'Rust preventive additive system',  function: 'Proprietary inhibitor package — primary corrosion protection',         percent: '—', compat: 'Ferrous, non-ferrous' },
          { name: 'Metal sulfonate inhibitor',        function: 'Interfacial corrosion protection — polar bonding to metal surface',    percent: '—', compat: 'All metals' },
          { name: 'Fatty acid derivative',            function: 'Surface-adhesive film agent — enhances film tenacity and adhesion',    percent: '—', compat: 'All metals' },
          { name: 'Nonionic surfactant',              function: 'Water displacement and wetting aid',                                   percent: '—', compat: 'All metals' },
        ],
        application: [
          { step: '1', name: 'Pre-clean surface',      param: 'Dry, rust-free, grease-free substrate', value: 'Essential for maximum film adhesion' },
          { step: '2', name: 'Apply CORRCUT 100',       param: 'Dip or spray',                         value: 'Ensure uniform coverage; 15–30 s dip time' },
          { step: '3', name: 'Drain',                   param: 'Vertical draining',                    value: '15–30 min' },
          { step: '4', name: 'Allow film to cure',      param: 'Air dry at ambient temperature',       value: '30–45 min, non-tacky film' },
          { step: '5', name: 'Remove before use',       param: 'Alkaline degreaser',                   value: 'Wash off prior to further processing' },
        ],
        packaging: [
          { size: '35', unit: 'L', type: 'HDPE jerrycan' },
          { size: '50', unit: 'L', type: 'HDPE jerrycan' },
        ...
        performance: [
          { label: 'Salt spray (uncoated)',  val: '≥ 96 h (ASTM B117)' },
          { label: 'Humidity cabinet',       val: '≥ 500 h (ASTM D1748)' },
          { label: 'Water displacement',     val: '> 98 %' },
          { label: 'Dry time (ambient)',      val: '30–45 min, non-tacky film' },
        ],
        safetyNote: 'Flammable liquid — keep away from ignition sources and heat. Ensure adequate ventilation during application. Refer to the current SDS (SDS-UCR-001) for full hazard information and PPE requirements.',
      },
    },
  },

  {
    productKey: 'corrcut-100',
    docType:    'msds',
    docNumber:  'SDS-UCR-001',
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'SDS-UCR-001 Rev 01 · Jun 2026',
      center: 'This Safety Data Sheet is provided in good faith based on current knowledge. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nGHS Rev 9 Compliant · Page 1 of 1',
    },
    body: {
      ...
      sections: {
        identification: {
          productType:  'Mineral oil-based rust preventive and corrosion protection fluid',
          intendedUse:  'Temporary rust prevention of ferrous and non-ferrous components during in-process handling, transit, and storage; applied by dip or spray',
          manufacturer: 'Macro Coats Pvt Ltd, Chennai, Tamil Nadu, India',
          emergency:    'AIIMS Poison Control: 1800-11-6117 (Toll-Free)',
        },
        hazards: {
        ...
        composition: {
          ingredients: [
            { name: 'Aliphatic hydrocarbon solvent',   description: 'Carrier and viscosity diluent — low-aromatic aliphatic hydrocarbon',     percent: '—', ghsClass: 'Aspiration Hazard / Flammable', tagType: 'danger' },
            { name: 'Mineral base oil',                description: 'Primary film-forming base — petroleum-derived mineral oil',              percent: '—', ghsClass: 'Aspiration Hazard',             tagType: 'warn'   },
            { name: 'Rust preventive additive system', description: 'Proprietary inhibitor package for corrosion protection',                 percent: '—', ghsClass: 'Irritant',                     tagType: 'warn'   },
            { name: 'Metal sulfonate inhibitor',       description: 'Interfacial corrosion protection agent',                                 percent: '—', ghsClass: 'None',                         tagType: 'safe'   },
            { name: 'Fatty acid derivative',           description: 'Film adhesion and surface protection agent',                             percent: '—', ghsClass: 'None',                         tagType: 'safe'   },
            { name: 'Nonionic surfactant',             description: 'Water displacement and wetting aid',                                     percent: '—', ghsClass: 'None',                         tagType: 'safe'   },
          ],
          note: 'Exact formulation is proprietary. Functional ingredient descriptions are provided for safety and emergency purposes only.',
        },
        firstAid: {
          ...
          inhalation: 'Move to fresh air. If symptoms persist, seek medical attention.',
          ingestion:  'Do NOT induce vomiting — aspiration risk. Seek immediate medical attention.',
          warning:    '⚠ Do NOT induce vomiting — mineral hydrocarbons carry high aspiration risk into lungs.',
        },
        fireFighting: {
          flammability:       'Flammable liquid — flash point > 60 °C',
          extinguishingMedia: 'CO₂, dry powder, foam. Do NOT use water jet on burning liquid.',
          fireHazard:         'Thermal decomposition may generate CO, CO₂, and hydrocarbon vapours.',
          ppe:                'SCBA and full fire-resistant protective clothing.',
        },
        accidentalRelease: [
          'Eliminate all ignition sources immediately — flammable vapour risk',
          'Contain spill with inert absorbent material (sand, vermiculite)',
          'Prevent entry into drains and waterways — harmful to aquatic organisms',
          'Collect contaminated material into sealed, labelled HDPE containers',
          'Dispose as petroleum waste per CPCB Hazardous Waste Management Rules 2016',
        ],
        handling: {
          handling:     'Apply by dip or spray. Keep away from heat, sparks, open flames, and all ignition sources. Handle in well-ventilated areas.',
          storageTemp:  '5 °C – 40 °C; cool, dry, well-ventilated area; away from heat sources and direct sunlight',
          containers:   'Sealed HDPE or steel containers; keep tightly closed when not in use',
          segregation:  'Store separately from oxidising agents, strong acids, and strong alkalis',
          shelfLife:    '24 months from date of manufacture in original sealed containers',
        },
        ...
        physical: [
          { key: 'Appearance',    val: 'Clear to pale amber liquid' },
          { key: 'Odour',         val: 'Mild petroleum / hydrocarbon characteristic' },
          { key: 'Flash Point',   val: '> 60 °C (ASTM D93)' },
          { key: 'Density',       val: '0.80 – 0.87 g/mL' },
          { key: 'Viscosity',     val: '5 – 15 cSt at 40 °C' },
          { key: 'Solubility',    val: 'Insoluble in water' },
          { key: 'Boiling Point', val: '> 150 °C' },
          { key: 'Vapour Pres.',  val: 'Low at ambient temperature' },
        ],
        ...
        sections11to16: {
          'Skin / Eye': 'Mild skin irritant on prolonged contact. Flush with water immediately.',
          Aquatic:      'H412 — harmful to aquatic life with long lasting effects. Do not discharge to drains, waterways, or soil.',
          Disposal:     'Recover and recycle where possible. Dispose via licensed waste contractor per CPCB/SPCB norms (E.P. Act 1986).',
          Regulatory:   'MSIHC Rules 1989 · Factories Act 1948 · Hazardous Waste Rules 2016 · GHS Rev 9',
          'Other Info': 'SDS Rev 01 issued Jun 2026. Next review: Jun 2028 or upon formulation change.',
...

  {
    productKey: 'corrcut-100',
    docType:    'formula',
    docNumber:  'FRM-UCR-001',
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'FRM-UCR-001 Rev 01 · Jun 2026',
      center: 'CONFIDENTIAL — This formulation sheet is the proprietary information of Macro Coats Pvt Ltd. Unauthorised reproduction or disclosure is prohibited.',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      ...
      referenceBatchSize: 100,
      batchUnit:          'L',
      totalActivePercent: 99,
      overview: 'CORRCUT 100 is a mineral oil-based rust preventive formulated for robust temporary corrosion protection. The product combines a light hydrocarbon carrier with mineral base oil, a barium-free rust preventive additive package, petroleum sulfonate, and a lanolin fatty derivative to produce an adherent, dry-to-touch protective film. A low-HLB nonionic surfactant aids water displacement.',
      composition: [
        { srNo: 1, name: 'Dearomatized Hydrocarbon Solvent (D60 type)', casNo: '64742-47-8', baseQty: 70.0, unit: 'L',  percentWV: 70.0, function: 'Primary carrier — fast-drying aliphatic solvent, low aromatic content',                        density: 0.79, unitPrice: 70  },
        { srNo: 2, name: 'Mineral Oil (ISO VG 15)',                      casNo: '8042-47-5',  baseQty: 12.0, unit: 'L',  percentWV: 12.0, function: 'Base oil — builds film body and extends protection duration',                                 density: 0.86, unitPrice: 65  },
        { srNo: 3, name: 'Rust Preventive Additive Package (Barium-free)', casNo: 'Mixture', baseQty: 8.0,  unit: 'L',  percentWV: 8.0,  function: 'Primary corrosion inhibitor package — multi-mechanism rust protection',                        density: 0.98, unitPrice: 220 },
        { srNo: 4, name: 'Petroleum Sulfonate (Calcium Salt)',           casNo: '61789-86-4', baseQty: 6.0,  unit: 'L',  percentWV: 6.0,  function: 'Secondary corrosion inhibitor — polar film on metal surface, neutralises acids',              density: 1.02, unitPrice: 155 },
        { srNo: 5, name: 'Lanolin Fatty Derivative / Wool Grease',      casNo: '8006-54-0',  baseQty: 3.5,  unit: 'kg', percentWV: 3.5,  function: 'Film adhesion promoter — natural wax-like film former, excellent water repellence',            density: 0.94, unitPrice: 310 },
        { srNo: 6, name: 'Nonionic Surfactant (Low HLB)',                casNo: 'Mixture',    baseQty: 0.5,  unit: 'L',  percentWV: 0.5,  function: 'Water displacement and wetting aid — improves surface penetration',                          density: 0.96, unitPrice: 280 },
      ],
      preparation: [
        { step: 1, title: 'Safety Setup',             detail: 'Ensure adequate ventilation. Wear nitrile gloves, safety goggles, and heat-resistant apron. Keep fire extinguisher accessible (Class B). Eliminate all ignition sources.' },
        { step: 2, title: 'Heat Carrier Solvent',     detail: 'Add 70 L of dearomatized hydrocarbon solvent (D60 type) to a stainless steel mixing vessel. Warm to 50–60 °C with slow stirring.' },
        { step: 3, title: 'Blend Mineral Oil',        detail: 'Add 12 L of Mineral Oil (ISO VG 15) to the heated solvent. Stir for 5 minutes until homogeneous.' },
        { step: 4, title: 'Add Additive Package',     detail: 'Add 8 L of the rust preventive additive package at 50 °C. Stir for 15 minutes until fully dispersed.' },
        { step: 5, title: 'Add Petroleum Sulfonate',  detail: 'Slowly add 6 L of Calcium Petroleum Sulfonate at 50 °C and mix for 10 minutes.' },
        { step: 6, title: 'Add Lanolin Derivative',   detail: 'Add 3.5 kg of Lanolin Fatty Derivative. Continue stirring at 50 °C until completely dissolved and blend is clear.' },
        { step: 7, title: 'Add Surfactant',           detail: 'Add 0.5 L of nonionic surfactant (Low HLB) at 45 °C. Mix for 5 minutes.' },
        { step: 8, title: 'Cool and QC Check',        detail: 'Allow batch to cool to ambient. Verify appearance (clear to pale amber), viscosity (5–15 cSt at 40 °C per ASTM D445), and flash point (>60 °C per ASTM D93). Fill into labelled HDPE containers.' },
      ],
      operatingConditions: [
        { param: 'Application Method',      value: 'Dip or spray' },
        { param: 'Application Temperature', value: '15 – 40 °C (ambient, no heating required)' },
        { param: 'Film Thickness',          value: '3 – 8 µm (dry, after dip + drain)' },
        { param: 'Dry Time',                value: '30 – 45 min at ambient (non-tacky)' },
        { param: 'Protection Period',       value: '3 – 12 months (indoor / covered storage)' },
      ],
      applications: {
        removes:    ['Surface moisture', 'Atmospheric oxygen exposure', 'Flash rust risk'],
        usedBefore: ['Inter-process transit', 'Medium-term storage', 'Pre-finishing holding stage', 'Export packaging'],
      },
    },
  },

  {
    ...
    body: {
      ...
      pCodes: [
        { code: 'P210',      text: 'Keep away from heat and ignition sources' },
        { code: 'P260',      text: 'Avoid breathing vapours or spray mist' },
        { code: 'P273',      text: 'Avoid release to the environment' },
        { code: 'P280',      text: 'Wear protective gloves and eye protection' },
        { code: 'P301+P310', text: 'If swallowed, immediately call a doctor' },
        { code: 'P302+P352', text: 'If on skin, wash with soap and water' },
      ...
      directions: [
        'Apply by dip, spray, or brush on clean, dry surface',
        'Allow protective film to dry 30–45 min at ambient',
        'Do not apply to hot surfaces (> 60 °C)',
        'Remove with alkaline degreaser before further processing',
      ],
      storage:  ['Store at 5°C – 40°C', 'Keep away from heat and ignition sources', 'Keep container tightly closed', 'Dispose per CPCB regulations'],
      products: ['CORRCUT 100', 'CORRCUT 100 PLUS', 'CORRCUT 100 CLEAR'],
    },
  },

  {
    productKey: 'corrcut-100',
    docType:    'coa',
    docNumber:  'COA-UCR-001',
    revision:   'Rev 01 — Jun 2026',
    footer: {
      left:   'COA-UCR-001 Rev 01 · Jun 2026',
      center: 'CONFIDENTIAL — For authorised recipients only · Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India',
    },
    body: {
      batchNumber:    'UCR-20260609-001',
      batchSize:      '100 L',
      productionDate: '09 Jun 2026',
      expiryDate:     'Jun 2028',
      grade:          'Industrial Grade',
      appearance:     'Clear to pale amber liquid',
      tests: [
        { parameter: 'Appearance',                        method: 'Visual',              specification: 'Clear to pale amber liquid',        result: 'Clear, pale amber liquid',       status: 'Pass' },
        { parameter: 'Flash Point',                       method: 'ASTM D93',            specification: '> 60 °C',                           result: '64 °C',                          status: 'Pass' },
        { parameter: 'Specific Gravity (25 °C)',           method: 'ISO 2811',            specification: '0.80 – 0.87',                       result: '0.83',                           status: 'Pass' },
        { parameter: 'Kinematic Viscosity (40 °C)',       method: 'ASTM D445',           specification: '5 – 15 cSt',                        result: '9.4 cSt',                        status: 'Pass' },
        { parameter: 'Film Thickness (dip application)',  method: 'Dry Film Gauge',      specification: '3 – 8 μm',                          result: '5 μm',                           status: 'Pass' },
        { parameter: 'Water Displacement',                method: 'Internal IM-002',     specification: '≥ 98 %',                            result: '98.8 %',                         status: 'Pass' },
      ...
      statement: 'We hereby certify that the above batch of CORRCUT 100 has been manufactured, tested, and inspected in accordance with our internal quality specifications. All parameters conform to the product specification and the product is approved for release.',
      approvals: {
        preparedBy: 'Quality Analyst — Macro Coats',
        reviewedBy: 'QC Manager — Macro Coats',
        approvedBy: 'Operations Head — Macro Coats',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    revision:   'Rev 02 — Jul 2026',
    footer: {
      left:   'TDS-UCC-001 Rev 02 · Jul 2026',
      center: 'This Technical Data Sheet is for guidance only. Performance figures are typical values obtained under controlled conditions. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      ...
      sections: {
        ...
        physicalProperties: [
          { property: 'Appearance',                  value: 'Clear, pale amber fluid',                    unit: '—',      method: 'Visual' },
          { property: 'Density @ 25°C',              value: '0.78 – 0.85',                                unit: 'g/mL',   method: 'ISO 2811' },
          { property: 'Kinematic Viscosity @ 40°C',  value: '3 – 8',                                       unit: 'cSt',    method: 'ASTM D445' },
          { property: 'Flash Point (PMCC)',          value: '> 35',                                       unit: '°C',     method: 'ASTM D93' },
          { property: 'Protective Film Classification', value: 'Thin, lightly oily protective film (petroleum jelly reinforced)', unit: '—', method: 'Internal' },
          { property: 'Estimated Film Thickness',    value: '2.0 – 6.0',                                  unit: 'μm',     method: 'Micrometer' },
          { property: 'Theoretical Consumption Coverage', value: '35 – 50',                                unit: 'm²/L',   method: 'Calculated' },
          { property: 'Water Displacement Performance', value: 'Passes complete shedding verification',    unit: '—',      method: 'IS 1154' },
          { property: 'Indoor Protection Period',    value: '3 – 6',                                      unit: 'months', method: 'Environmental — guidance only' },
        ...
        application: [
          ...
          { step: '3', name: 'Drain',                param: 'Vertical draining',                    value: '15–30 min' },
          { step: '4', name: 'Allow film to set',    param: 'Air dry at ambient temperature',       value: '20–30 min; film remains lightly oily, not fully dry' },
          { step: '5', name: 'Remove before use',    param: 'Alkaline degreaser or mineral spirits', value: 'Wash off prior to further processing' },
        ],
        packaging: [
          { size: '20',  unit: 'L', type: 'HDPE carboys' },
          { size: '210', unit: 'L', type: 'Steel drums' },
        ],
        performance: [
          { label: 'Salt spray resistance',   val: '≥ 96 h (ASTM B117)' },
          { label: 'Indoor Protection',       val: '3–6 Months' },
          { label: 'Outdoor Covered',         val: '1–3 Months' },
...

  {
    productKey: 'corrucut-500',
    docType:    'msds',
    docNumber:  'SDS-UCC-001',
    revision:   'Rev 02 — Jul 2026',
    footer: {
      left:   'SDS-UCC-001 Rev 02 · Jul 2026',
      center: 'This Safety Data Sheet is provided in good faith based on current knowledge. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nGHS Rev 9 Compliant · Page 1 of 1',
    },
    body: {
      ...
      sections: {
        identification: {
          productType:  'Dearomatized hydrocarbon-based corrosion preventive fluid',
          intendedUse:  'Temporary rust prevention of ferrous and non-ferrous components during inprocess handling, transit, and storage phases.',
          manufacturer: 'Macro Coats Pvt. Ltd., Chennai, India',
          emergency:    'AIIMS Poison Control Centre: 1800-11-6117 (24/7 Toll-Free)',
        },
        hazards: {
          pictograms:      ['flammable', 'health', 'environment'],
          classifications: [
            { class: 'Flammable Liquid',           category: 'Category 3', tagType: 'warn'   },
            { class: 'Aspiration Hazard',          category: 'Category 1', tagType: 'danger' },
            { class: 'Skin Irritation',            category: 'Category 2', tagType: 'warn'   },
            { class: 'Aquatic Toxicity (Chronic)', category: 'Category 3', tagType: 'warn'   },
          ],
          hStatements: 'H226 — Flammable liquid and vapour. H304 — May be fatal if swallowed and enters airways. H315 — Causes skin irritation. H412 — Harmful to aquatic life with long lasting effects.',
          pStatements: 'P210 — Keep away from heat, hot surfaces, sparks, open flames and other ignition sources. No smoking. · P260 — Do not breathe dust/fume/gas/mist/vapours/spray. · P273 — Avoid release to the environment. · P280 — Wear protective gloves/protective clothing/eye protection/face protection. · P301 + P310 — IF SWALLOWED: Immediately call a POISON CENTER or doctor/physician. · P302 + P352 — IF ON SKIN: Wash with plenty of soap and water. · P331 — Do NOT induce vomiting.',
        },
        composition: {
          ingredients: [
            { name: 'Exxsol D60',                             description: 'Primary carrier solvent',   percent: '50% – 65%', ghsClass: 'Asp. Tox. 1 / Flam. Liq. 3', tagType: 'danger' },
            { name: 'Exxsol D145',                            description: 'Secondary carrier solvent', percent: '15% – 25%', ghsClass: 'Asp. Tox. 1',                tagType: 'warn'   },
            { name: 'Exxsol 32D',                             description: 'Light carrier fraction',    percent: '2% – 6%',   ghsClass: 'Flam. Liq. 3',               tagType: 'warn'   },
            { name: 'Calcium Petroleum Sulfonate',            description: 'Primary rust inhibitor',    percent: '10% – 16%', ghsClass: 'Skin Irrit. 2',              tagType: 'warn'   },
            { name: 'Vaseline (Petroleum Jelly)',             description: 'Film-forming barrier agent', percent: '4% – 8%',  ghsClass: 'Not Classified',             tagType: 'safe'   },
          ],
          note: '* Formulation values are proprietary. Structural designations are provided in full accordance with safe manufacturing norms.',
        },
        firstAid: {
          eyes:       'Flush immediately with continuous flowing water for 15 minutes, holding eyelids apart. Obtain medical validation if burning persists.',
          skin:       'Remove contaminated industrial gear. Cleanse target skin zones thoroughly using neutral soap and water. Get medical aid if a persistent rash develops.',
          inhalation: 'Relocate the individual to clean fresh air zones. Administer respiratory aid if breathing becomes labored.',
          ingestion:  'Do NOT induce vomiting. High risk of severe chemical pneumonitis caused by liquid aspiration into lungs. Transport immediately to an emergency care room.',
          warning:    '⚠ CRITICAL NOTICE FOR INTENSIVE MEDICINE: Hydrocarbon elements present an elite risk of pulmonary aspiration. Treatment must be performed symptomatically based on exposure kinetics.',
        },
        fireFighting: {
          flammability:       'Flammable formulation (Flash Point > 35°C)',
          extinguishingMedia: 'Carbon Dioxide (CO₂), dry chemical powder, or alcohol-resistant fire foam.',
          fireHazard:         'Oxidative combustion yields carbon monoxide (CO), carbon dioxide (CO₂), and dense reactive fumes. Do NOT apply high-pressure water jets, as it will accelerate liquid propagation.',
          ppe:                'SCBA and full fire-resistant protective clothing.',
        },
        accidentalRelease: [
          'Dermal & Vapour Precautions: Isolate all ignition nodes instantly. Evacuate staff from immediate downwind sectors and optimize clean air exchange.',
          'Containment Perimeter: Prevent fluid migration into public water tables, municipal sewers, or agricultural topsoil matrices.',
          'Decontamination Strategy: Absorb volume using mineral-grade non-combustible binders (vermiculite, clay, or dry sand). Shovel into distinct, code-compliant HDPE dump drums for legal elimination.',
        ],
        handling: {
          handling:     'Avoid structural aerosol generation or mist inhalation. Enforce standard grounding wire configurations during high-volume transfers to eliminate static arcs.',
          storageTemp:  '5°C and 40°C. Keep storage units isolated from aggressive sunlight exposure and dynamic heat grids.',
          containers:   'Sealed HDPE or steel containers; keep tightly closed when not in use. Isolate completely from concentrated chemical oxidizers, strong nitric/sulfuric acids, and basic alkaline chemicals.',
          segregation:  'Store separately from oxidising agents, strong acids, and strong alkalis',
          shelfLife:    '24 months from the date of synthesis when preserved in original, unopened factory units under recommended thermal windows (5°C to 40°C).',
        },
        exposure: {
          ppeItems:    ['Safety Glasses', 'Nitrile Gloves', 'Industrial Overalls', 'Closed-toe Shoes'],
          engineering: 'Enforce local exhaust containment mechanisms to retain chemical mists below permissible limits (5 mg/m³ TWA for mineral oil mists). Deploy side-shielded chemical safety goggles conforming strictly to ANSI Z87.1 benchmarks. Mandate high-performance Nitrile rubber gloves (breakthrough evaluation exceeding 480 minutes) and protective industrial factory overalls.',
        },
        physical: [
          { key: 'Physical State',   val: 'Clear, pale amber liquid' },
          { key: 'Odour Threshold',  val: 'Mild petroleum signature' },
          { key: 'Flash Point',      val: '> 35 °C (ASTM D93)' },
          { key: 'Relative Density', val: '0.78 – 0.85 g/mL' },
          { key: 'Kinematic Viscosity', val: '3 – 8 cSt @ 40 °C' },
          { key: 'Initial Boiling Point', val: '> 150 °C' },
          { key: 'Water Solubility', val: 'Completely Insoluble' },
          { key: 'Vapour Pressure',  val: 'Negligible at ambient parameters' },
        ],
        stability: {
          stability:      'Chemically stable under standard temperature cycles.',
          avoid:          'Avoid extreme thermal loads and structural static conditions. Reacts aggressively with intense oxidising chemical agents.',
          decomposition:  'Combustion may produce CO, CO₂, and hydrocarbon fragments.',
          polymerisation: 'Will not occur',
        },
        toxicology: 'Aspiration Hazard: Classified Category 1. Severe danger of entry into breathing channels, causing chemical-induced pulmonary edema. Prolonged dermal handling can dry out lipid profiles, culminating in mild contact dermatitis.',
        ecology: 'Classified as Aquatic Chronic Category 3. Toxic to aquatic organisms over extended time scales. Hydrocarbon chains form a physical barrier film on water surfaces, blocking standard oxygen equilibrium.',
        disposal: 'Must be handled strictly as hazardous petroleum waste chemical mass. Transfer to accredited treatment installations in line with State Pollution Control Board (SPCB) directives and Hazardous Waste Management Rules.',
        transport: 'Classified as UN 1268, Class 3 Flammable Liquid, Packing Group III for road/rail transit under national hazardous goods rules. For containerized global maritime shipments, handle under standard combustible classification parameters with leak-proof seals verified before vehicle dispatch.',
        regulatory: 'Governed under the Indian Factories Act (1948) and the Manufacture, Storage and Import of Hazardous Chemical (MSIHC) Rules 1989. This profile corresponds uniformly with GHS Revision 9 global criteria.',
        other: 'Document ID Code: SDS-UCC-001 Rev 02. Compilation Date: 19 July 2026. Corporate Warranty: The data compiled reflects our absolute best modern metric evaluations. Macro Coats Pvt. Ltd. extends no open warranties regarding the absolute validation of parameter scopes and disclaims liability for operational choices outside planned handling criteria.',
      },
    },
  },

  {
    productKey: 'corrucut-500',
    docType:    'formula',
    docNumber:  'FRM-UCC-001',
    revision:   'Rev 02 — Jul 2026',
    footer: {
      left:   'FRM-UCC-001 Rev 02 · Jul 2026',
      center: 'CONFIDENTIAL — This formulation sheet is the proprietary information of Macro Coats Pvt Ltd. Unauthorised reproduction or disclosure is prohibited.',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      classification:     'CONFIDENTIAL — Internal Use Only',
      batchSize:          '25 L (reference)',
      formulaType:        'liquid',
      referenceBatchSize: 25,
      batchUnit:          'L',
      totalActivePercent: 100,
      overview: 'CORRUCUT 500 (Rev 02) is a dearomatized hydrocarbon solvent-based corrosion preventive fluid built on a three-grade Exxsol carrier blend (D60, D145, and the lighter 32D fraction) for controlled evaporation and good surface penetration. Calcium petroleum sulfonate provides the primary corrosion-inhibiting film, and Vaseline (petroleum jelly) reinforces film cohesion and water resistance, producing a thin, lightly oily protective film rather than a fully dry one.',
      composition: [
        { srNo: 1, name: 'Exxsol D60',                  casNo: '64742-47-8', baseQty: 14.25, unit: 'L',  percentWV: 57.0, function: 'Primary carrier solvent — dearomatized aliphatic hydrocarbon, principal film-forming vehicle', density: 0.79,  unitPrice: 120 },
        { srNo: 2, name: 'Exxsol D145',                 casNo: 'Mixture',    baseQty: 5.00,  unit: 'L',  percentWV: 20.0, function: 'Secondary carrier — higher flash point fraction, extends evaporation profile',                 density: 0.795, unitPrice: 140 },
        { srNo: 3, name: 'Exxsol 32D',                  casNo: 'Mixture',    baseQty: 1.00,  unit: 'L',  percentWV: 4.0,  function: 'Light, fast-evaporating fraction — aids initial wetting and penetration',                     density: 0.76,  unitPrice: 110 },
        { srNo: 4, name: 'Calcium Petroleum Sulfonate',  casNo: '61789-86-4', baseQty: 3.25,  unit: 'kg', percentWV: 13.0, function: 'Primary corrosion inhibitor — polar film-forming rust preventive additive',                    density: 0.98,  unitPrice: 220 },
        { srNo: 5, name: 'Vaseline',                    casNo: '8009-03-8',  baseQty: 1.50,  unit: 'kg', percentWV: 6.0,  function: 'Film-forming barrier agent — petroleum jelly base enhances water resistance and film cohesion', density: 0.87,  unitPrice: 180 },
      ],
      preparation: [
        { step: 1, title: 'Safety Setup',             detail: 'Ensure adequate ventilation. Wear nitrile gloves, safety goggles, and heat-resistant apron. Keep fire extinguisher accessible (Class B — petroleum fires). Eliminate all ignition sources.' },
        { step: 2, title: 'Charge Exxsol D60',        detail: 'Add 14.25 L of Exxsol D60 to a stainless steel mixing vessel at ambient temperature with slow stirring.' },
        { step: 3, title: 'Add Exxsol D145 and 32D',  detail: 'Add 5.00 L of Exxsol D145, then 1.00 L of Exxsol 32D. Stir for 5 minutes until homogeneous.' },
        { step: 4, title: 'Melt and Blend Vaseline',  detail: 'Gently warm 1.50 kg of Vaseline to 45–50 °C until fluid, then add to the solvent blend with continuous stirring until fully dissolved and the mixture is clear.' },
        { step: 5, title: 'Add Calcium Petroleum Sulfonate', detail: 'Slowly add 3.25 kg of Calcium Petroleum Sulfonate at 40–45 °C. Stir for 15 minutes until fully dispersed.' },
        { step: 6, title: 'Cool and QC Check',        detail: 'Allow batch to cool to ambient. Verify appearance (clear to pale amber), viscosity (3–8 cSt at 40 °C per ASTM D445), and flash point (>35 °C per ASTM D93). Fill into labelled HDPE containers.' },
      ],
      operatingConditions: [
        { param: 'Application Method',      value: 'Dip or spray' },
        { param: 'Application Temperature', value: '15 – 40 °C (ambient, no heating required)' },
        { param: 'Film Thickness',          value: '2 – 6 µm (after dip + drain)' },
        { param: 'Dry Time',                value: '20 – 30 min at ambient (film remains lightly oily, not fully dry)' },
        { param: 'Protection Period',       value: '3 – 6 months indoor / 1 – 3 months outdoor covered storage' },
      ],
      applications: {
        removes:    ['Surface moisture', 'Atmospheric oxygen exposure', 'Flash rust risk'],
        usedBefore: ['Inter-process transit', 'Short-to-medium-term storage', 'Pre-finishing holding stage', 'Export packaging'],
      },
    },
  },

  {
    ...
    body: {
      ...
      directions: [
        'Apply by dip, spray, or brush on clean, dry surface',
        'Allow protective film to set 20–30 min at ambient (remains lightly oily, not fully dry)',
        'Do not apply to hot surfaces (> 50 °C)',
        'Remove with alkaline degreaser before further processing',
      ],
      storage:  ['Store at 5°C – 40°C', 'Keep away from heat and ignition sources', 'Keep container tightly closed', 'Dispose per CPCB regulations'],
      products: ['CORRUCUT 500', 'CORRUCUT 500 PLUS', 'CORRUCUT 500 CLEAR'],
    },
  },

  {
    productKey: 'corrucut-500',
    docType:    'coa',
    docNumber:  'COA-UCC-001',
    revision:   'Rev 02 — Jul 2026',
    footer: {
      left:   'COA-UCC-001 Rev 02 · Jul 2026',
      center: 'CONFIDENTIAL — For authorised recipients only · Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India',
    },
    body: {
      batchNumber:    'UCC-20260719-001',
      batchSize:      '25 L',
      productionDate: '19 Jul 2026',
      expiryDate:     'Jul 2028',
      grade:          'Industrial Grade',
      appearance:     'Clear to pale amber liquid',
      tests: [
        { parameter: 'Appearance',                       method: 'Visual',              specification: 'Clear to pale amber liquid',          result: 'Clear, pale amber liquid',       status: 'Pass' },
        { parameter: 'Flash Point',                      method: 'ASTM D93',            specification: '> 35 °C',                             result: '38 °C',                          status: 'Pass' },
        { parameter: 'Specific Gravity (25 °C)',          method: 'ISO 2811',            specification: '0.78 – 0.85',                         result: '0.82',                           status: 'Pass' },
        { parameter: 'Kinematic Viscosity (40 °C)',      method: 'ASTM D445',           specification: '3 – 8 cSt',                           result: '5.0 cSt',                        status: 'Pass' },
        { parameter: 'Film Thickness (dip application)', method: 'Dry Film Gauge',      specification: '2 – 6 μm',                            result: '4 μm',                           status: 'Pass' },
        { parameter: 'Water Displacement',               method: 'Internal IM-002',     specification: '≥ 99 %',                              result: '99.4 %',                         status: 'Pass' },
        { parameter: 'Salt Spray Resistance (96 h)',      method: 'ASTM B117',           specification: 'No rust formation in 96 h',           result: 'No rust observed at 96 h',       status: 'Pass' },
      ],
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    productKey: 'corrcut-200',
    docType:    'tds',
    docNumber:  'TDS-UC2-001',
    revision:   'Rev 01 — Jul 2026',
    footer: {
      left:   'TDS-UC2-001 Rev 01 · Jul 2026',
      center: 'This Technical Data Sheet is for guidance only. Performance figures are typical values obtained under controlled conditions. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      grade:       'Industrial Grade',
      description: 'CORRCUT 200 is an economical solvent-based rust preventive oil designed for temporary indoor protection of ferrous components. It forms a thin oily protective film after solvent evaporation, providing corrosion protection during storage and inter-process handling. Recommended for machined components, forged parts, castings, automotive components, and general engineering parts held in indoor storage or inter-process protection.',
      sections: {
        features: [
          { head: 'Economical Solvent-Based Protection', body: 'MTO + dearomatized hydrocarbon carrier gives reliable indoor rust protection at a lower cost than mineral-oil-based systems' },
          { head: 'Thin Oily Film',                       body: 'Deposits a light, non-heavy protective film that is easy to remove before further processing' },
          { head: 'Versatile Application',                body: 'Applicable by dip, spray, brush, or flow coat to suit different production line layouts' },
          { head: 'Recommended Uses',                     body: 'Indoor storage protection, temporary rust prevention, finished components before packing, and components awaiting assembly' },
        ],
        physicalProperties: [
          { property: 'Appearance',         value: 'Clear to pale yellow liquid',            unit: '—',    method: 'Visual' },
          ...
          { property: 'Coverage',           value: '8 – 10',                                 unit: 'm²/L', method: 'Internal estimate' },
          { property: 'Protection Period',  value: 'Approx. 1 – 3 months (indoor guidance)',  unit: '—',    method: 'Internal — guidance only' },
        ],
        composition: [
          { name: 'Mineral Turpentine Oil (MTO)',        function: 'Primary carrier — fast-evaporating aliphatic solvent for economical film deposition',              percent: '—', compat: 'All metals' },
          { name: 'Dearomatized Hydrocarbon Solvent',    function: 'Secondary carrier — controlled evaporation, low aromatic content for reduced odour',                percent: '—', compat: 'All metals' },
          { name: 'Calcium Petroleum Sulfonate',         function: 'Primary corrosion inhibitor — polar film-forming rust preventive additive',                        percent: '—', compat: 'Ferrous, non-ferrous' },
          { name: 'Lanolin',                             function: 'Film adhesion promoter — natural wax-like film former, enhances water repellence',                  percent: '—', compat: 'All metals' },
          { name: 'Sorbitan Monooleate (Span 80)',       function: 'Emulsifier / dispersing agent — stabilises additive package for a uniform film',                    percent: '—', compat: 'All metals' },
          { name: 'BHT (Antioxidant)',                   function: 'Antioxidant / stabiliser — prevents oxidative degradation of the protective film',                  percent: '—', compat: 'All metals' },
        ],
        application: [
          { step: '1', name: 'Pre-clean surface',   param: 'Dry, rust-free, grease-free substrate', value: 'Essential for maximum film adhesion' },
          { step: '2', name: 'Apply CORRCUT 200',    param: 'Dip, spray, brush, or flow coat',       value: 'Ensure uniform coverage; 10–20 s dip time' },
          { step: '3', name: 'Drain',                param: 'Vertical draining',                     value: '10–20 min' },
          { step: '4', name: 'Allow film to cure',   param: 'Air dry at ambient temperature',         value: '20–30 min, thin oily film' },
          { step: '5', name: 'Remove before use',    param: 'Mild solvent wash or degreaser',         value: 'If required prior to further processing' },
        ],
        packaging: [
          { size: '35', unit: 'L', type: 'HDPE jerrycan' },
          { size: '50', unit: 'L', type: 'HDPE jerrycan' },
        ...
        performance: [
          { label: 'Protection', val: 'Indoor storage — guidance only' },
          { label: 'Expected Protection Period', val: 'Approximately 1–3 months under normal indoor storage conditions' },
          { label: 'Film Type',  val: 'Thin oily protective film' },
          { label: 'Dry / Cure Time (ambient)', val: '20–30 min' },
          { label: 'Application Temperature', val: 'Ambient' },
          { label: 'Application Methods', val: 'Dip, Spray, Brush, Flow Coat' },
        ],
        safetyNote: 'Flammable liquid — keep away from ignition sources and heat. Ensure adequate ventilation during application. Refer to the current SDS (SDS-UC2-001) for full hazard information and PPE requirements.',
      },
    },
  },

  {
    productKey: 'corrcut-200',
    docType:    'msds',
    docNumber:  'SDS-UC2-001',
    revision:   'Rev 01 — Jul 2026',
    footer: {
      left:   'SDS-UC2-001 Rev 01 · Jul 2026',
      center: 'This Safety Data Sheet is provided in good faith based on current knowledge. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nGHS Rev 9 Compliant · Page 1 of 1',
    },
    body: {
      ...
      sections: {
        identification: {
          productType:  'Economical solvent-based rust preventive oil for temporary indoor protection of ferrous components',
          intendedUse:  'Temporary rust prevention of ferrous components during indoor storage, inter-process protection, and pre-assembly holding; applied by dip, spray, brush, or flow coat',
          manufacturer: 'Macro Coats Pvt Ltd, Chennai, Tamil Nadu, India',
          emergency:    'AIIMS Poison Control: 1800-11-6117 (Toll-Free)',
        },
        hazards: {
        ...
        composition: {
          ingredients: [
            { name: 'Mineral Turpentine Oil (MTO)',      description: 'Primary solvent carrier — economical aliphatic petroleum distillate',        ghsClass: 'Flammable / Aspiration Hazard', tagType: 'danger' },
            { name: 'Dearomatized Hydrocarbon Solvent',  description: 'Secondary carrier — low-aromatic hydrocarbon solvent',                       ghsClass: 'Aspiration Hazard',             tagType: 'warn'   },
            { name: 'Calcium Petroleum Sulfonate',       description: 'Corrosion inhibitor package for interfacial rust protection',                                                                  ghsClass: 'Irritant',                     tagType: 'warn'   },
            { name: 'Lanolin',                           description: 'Film adhesion and water-repellence agent',                                                                                      ghsClass: 'None',                         tagType: 'safe'   },
            { name: 'Sorbitan Monooleate (Span 80)',     description: 'Emulsifier / dispersing agent',                                                                                                  ghsClass: 'None',                         tagType: 'safe'   },
            { name: 'BHT (Antioxidant)',                 description: 'Film stabiliser — prevents oxidative degradation',                                                                              ghsClass: 'Mild Irritant',                tagType: 'warn'   },
          ],
          note: 'Exact formulation is proprietary. Functional ingredient descriptions are provided for safety and emergency purposes only.',
        },
        firstAid: {
        ...
        fireFighting: {
          flammability:       'Flammable liquid — flash point > 40 °C',
          extinguishingMedia: 'CO₂, dry powder, foam. Do NOT use water jet on burning liquid.',
          fireHazard:         'Thermal decomposition may generate CO, CO₂, and hydrocarbon vapours.',
          ppe:                'SCBA and full fire-resistant protective clothing.',
        },
        ...
        handling: {
          handling:     'Apply by dip, spray, brush, or flow coat. Keep away from heat, sparks, open flames, and all ignition sources. Handle in well-ventilated areas.',
          storageTemp:  '5 °C – 40 °C; cool, dry, well-ventilated area; away from heat sources and direct sunlight',
          containers:   'Sealed HDPE or steel containers; keep tightly closed when not in use',
          segregation:  'Store separately from oxidising agents, strong acids, and strong alkalis',
          shelfLife:    '24 months from date of manufacture in original sealed containers',
        ...
        physical: [
          { key: 'Appearance',    val: 'Clear to pale yellow liquid' },
          { key: 'Odour',         val: 'Mild solvent odour' },
          { key: 'Flash Point',   val: '> 40 °C (ASTM D93)' },
          { key: 'Density',       val: '0.79 – 0.83 g/mL' },
          { key: 'Viscosity',     val: '2 – 6 cSt at 40 °C' },
          { key: 'Solubility',    val: 'Insoluble in water' },
          { key: 'Boiling Point', val: '> 140 °C' },
          { key: 'Vapour Pres.',  val: 'Moderate at ambient temperature' },
        ],
        stability: {
          stability:      'Stable under recommended storage conditions.',
          avoid:          'Strong oxidising agents, excessive heat, open flame, ignition sources',
...

  {
    productKey: 'corrcut-200',
    docType:    'formula',
    docNumber:  'FRM-UC2-001',
    revision:   'Rev 01 — Jul 2026',
    footer: {
      left:   'FRM-UC2-001 Rev 01 · Jul 2026',
      center: 'CONFIDENTIAL — This formulation sheet is the proprietary information of Macro Coats Pvt Ltd. Unauthorised reproduction or disclosure is prohibited.',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      ...
      batchUnit:          'L',
      totalActivePercent: 100,
      overview: 'CORRCUT 200 is an economical solvent-based rust preventive oil built on a Mineral Turpentine Oil (MTO) and dearomatized hydrocarbon (Exxsol D145) carrier blend. Calcium petroleum sulfonate provides the primary corrosion-inhibiting film, lanolin promotes film adhesion and water repellence, Span 80 stabilises the additive dispersion, and BHT protects the film from oxidative degradation during storage.',
      composition: [
        { srNo: 1, name: 'Mineral Turpentine Oil (MTO)',      casNo: '8052-41-3',  baseQty: 55.0, unit: 'L',  percentWV: 55.0, function: 'Primary solvent carrier — economical aliphatic hydrocarbon for fast evaporation and film deposition',      density: 0.795, unitPrice: 75  },
        { srNo: 2, name: 'Exxsol D145',                        casNo: 'Mixture',    baseQty: 35.0, unit: 'L',  percentWV: 35.0, function: 'Secondary carrier solvent — dearomatized, higher flash point hydrocarbon for controlled evaporation and low odour', density: 0.79,  unitPrice: 92  },
        { srNo: 3, name: 'Calcium Petroleum Sulfonate',        casNo: '61789-86-4', baseQty: 8.0,  unit: 'L',  percentWV: 8.0,  function: 'Primary corrosion inhibitor — polar film-forming rust preventive additive',                                density: 0.98,  unitPrice: 220 },
        { srNo: 4, name: 'Lanolin',                            casNo: '8006-54-0',  baseQty: 1.5,  unit: 'kg', percentWV: 1.5,  function: 'Film adhesion promoter — natural wax-like film former, enhances water repellence',                          density: 0.94,  unitPrice: 310 },
        { srNo: 5, name: 'Span 80 (Sorbitan Monooleate)',      casNo: '1338-43-8',  baseQty: 0.3,  unit: 'kg', percentWV: 0.3,  function: 'Emulsifier / surface-active agent — stabilises additive dispersion for uniform film',                       density: 0.99,  unitPrice: 450 },
        { srNo: 6, name: 'BHT (Butylated Hydroxytoluene)',     casNo: '128-37-0',   baseQty: 0.2,  unit: 'kg', percentWV: 0.2,  function: 'Antioxidant / stabiliser — prevents oxidative degradation of the protective film',                          density: 1.05,  unitPrice: 600 },
      ],
      preparation: [
        { step: 1, title: 'Safety Setup',                 detail: 'Ensure adequate ventilation. Wear nitrile gloves, safety goggles, and heat-resistant apron. Keep fire extinguisher accessible (Class B). Eliminate all ignition sources.' },
        { step: 2, title: 'Charge Mineral Turpentine Oil', detail: 'Add 55 L of Mineral Turpentine Oil (MTO) to a stainless steel mixing vessel at ambient temperature with slow stirring.' },
        { step: 3, title: 'Add Exxsol D145',               detail: 'Add 35 L of Exxsol D145 to the vessel. Stir for 5 minutes until homogeneous.' },
        { step: 4, title: 'Add Calcium Petroleum Sulfonate', detail: 'Slowly add 8 L of Calcium Petroleum Sulfonate. Stir for 15 minutes until fully dispersed.' },
        { step: 5, title: 'Add Lanolin',                   detail: 'Add 1.5 kg of Lanolin. Continue stirring at ambient temperature until completely dissolved and the blend is clear.' },
        { step: 6, title: 'Add Span 80',                   detail: 'Add 0.3 kg of Span 80. Mix for 5 minutes until uniformly dispersed.' },
        { step: 7, title: 'Add BHT',                       detail: 'Add 0.2 kg of BHT. Stir until fully dissolved.' },
        { step: 8, title: 'QC Check and Fill',              detail: 'Verify appearance (clear to pale yellow), viscosity (2–6 cSt at 40 °C per ASTM D445), flash point (>40 °C per ASTM D93), and specific gravity (0.79–0.83). Fill into labelled HDPE containers.' },
      ],
      operatingConditions: [
        { param: 'Application Method',      value: 'Dip, Spray, Brush, or Flow Coat' },
        { param: 'Application Temperature', value: 'Ambient (15 – 35 °C, no heating required)' },
        { param: 'Film Thickness',          value: '2 – 5 µm (dry, thin oily film)' },
        { param: 'Dry Time',                value: '20 – 30 min at ambient (thin oily film)' },
        { param: 'Protection Period',       value: 'Approximately 1 – 3 months (indoor storage — guidance only)' },
      ],
      applications: {
        removes:    ['Surface moisture', 'Flash rust risk', 'Handling / fingerprint corrosion'],
        usedBefore: ['Indoor storage', 'Inter-process protection', 'Assembly staging', 'Packing of finished components'],
      },
    },
  },

  {
    ...
    body: {
      ...
      directions: [
        'Apply by dip, spray, brush, or flow coat on clean, dry surface',
        'Allow protective film to dry 20–30 min at ambient',
        'Do not apply to hot surfaces (> 50 °C)',
        'Suitable for indoor storage and inter-process protection only',
      ],
      storage:  ['Store at 5°C – 40°C', 'Keep away from heat and ignition sources', 'Keep container tightly closed', 'Dispose per CPCB regulations'],
      products: ['CORRCUT 200'],
    },
  },

  {
    productKey: 'corrcut-200',
    docType:    'coa',
    docNumber:  'COA-UC2-001',
    revision:   'Rev 01 — Jul 2026',
    footer: {
      left:   'COA-UC2-001 Rev 01 · Jul 2026',
      center: 'CONFIDENTIAL — For authorised recipients only · Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India',
    },
    body: {
      batchNumber:    'UC2-20260719-001',
      batchSize:      '100 L',
      productionDate: '19 Jul 2026',
      expiryDate:     'Jul 2028',
      grade:          'Industrial Grade',
      ...
      tests: [
        { parameter: 'Appearance',                       method: 'Visual',          specification: 'Clear to pale yellow liquid', result: 'Clear, pale yellow liquid', status: 'Pass' },
        { parameter: 'Flash Point',                       method: 'ASTM D93',        specification: '> 40 °C',                     result: '43 °C',                     status: 'Pass' },
        { parameter: 'Specific Gravity (25 °C)',          method: 'ISO 2811',        specification: '0.79 – 0.83',                 result: '0.81',                      status: 'Pass' },
        { parameter: 'Kinematic Viscosity (40 °C)',       method: 'ASTM D445',       specification: '2 – 6 cSt',                   result: '3.9 cSt',                   status: 'Pass' },
        { parameter: 'Dry Time (ambient)',                method: 'Internal IM-001', specification: '20 – 30 min',                 result: '25 min',                    status: 'Pass' },
        { parameter: 'Salt Spray Resistance (48 h)',      method: 'ASTM B117',       specification: 'No rust formation in 48 h',   result: 'No rust observed at 48 h',  status: 'Pass' },
      ],
      statement: 'We hereby certify that the above batch of CORRCUT 200 has been manufactured, tested, and inspected in accordance with our internal quality specifications. All parameters conform to the product specification and the product is approved for release.',
      approvals: {
        preparedBy: 'Quality Analyst — Macro Coats',
        reviewedBy: 'QC Manager — Macro Coats',
        approvedBy: 'Operations Head — Macro Coats',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    productKey: 'unicut-al',
    docType:    'tds',
    docNumber:  'TDS-UCA-001',
    revision:   'Rev 01 — Jul 2026',
    footer: {
      left:   'TDS-UCA-001 Rev 01 · Jul 2026',
      center: 'This Technical Data Sheet is for guidance only. Performance figures are typical values obtained under controlled conditions. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      grade:       'Industrial Grade — Water Dilutable Metalworking Fluid',
      description: 'UNICUT-AL is a semi-synthetic water-miscible cutting fluid specially developed for machining, drilling, milling, turning and grinding of aluminium and aluminium alloys. It combines excellent cooling and lubrication with very low staining on aluminium, hard water stability, and long sump life.',
      sections: {
        features: [
          { head: 'Excellent Cooling & Lubrication', body: 'Balanced semi-synthetic chemistry delivers high heat dissipation together with good boundary lubrication for reduced tool wear and better surface finish' },
          { head: 'Aluminium-Safe Formulation',       body: 'Very low staining on aluminium and aluminium alloys — validated for CNC, VMC, turning, milling, drilling and grinding of aluminium components, extrusions and die-cast parts' },
          { head: 'Low Foaming',                      body: 'Formulated for stable performance in high-pressure coolant systems and grinding applications without excessive foam build-up' },
          { head: 'Hard Water Stability',              body: 'Sodium gluconate sequestrant system maintains emulsion stability across a wide range of water hardness' },
          { head: 'Corrosion Protection',              body: 'Borax and amine-based inhibitor package provides excellent corrosion protection on machine surfaces and workpieces' },
          { head: 'Long Sump Life',                    body: 'Good emulsion stability and biocide-compatible formulation extend sump life and reduce fluid changeover frequency' },
        ],
        physicalProperties: [
          { property: 'Appearance',                        value: 'Milky White Liquid', unit: '—',      method: 'Visual' },
          { property: 'Colour',                             value: 'Milky White',        unit: '—',      method: 'Visual' },
          { property: 'Odour',                              value: 'Mild',               unit: '—',      method: '—' },
          { property: 'pH (5% Emulsion)',                   value: '9.2 – 9.6',          unit: '—',      method: 'pH Electrode' },
          { property: 'Specific Gravity',                   value: '0.98 – 1.02',        unit: '—',      method: 'ISO 2811' },
          { property: 'Mixing Ratio — General Machining',   value: '5',                  unit: '%',      method: 'Refractometer' },
          { property: 'Mixing Ratio — Heavy Machining',     value: '7 – 8',              unit: '%',      method: 'Refractometer' },
          { property: 'Mixing Ratio — Grinding',            value: '3 – 4',              unit: '%',      method: 'Refractometer' },
          { property: 'Shelf Life',                         value: '12',                 unit: 'Months', method: 'Sealed container, indoor storage away from direct sunlight' },
        ],
        composition: [
          { name: 'Deionised Water Carrier',          function: 'Base carrier and heat-transfer medium',                     percent: '76–80%', compat: 'All aluminium alloys' },
          { name: 'Paraffinic Mineral Oil System',    function: 'Boundary lubrication — reduces tool wear, improves finish', percent: '5–10%',  compat: 'Aluminium, ferrous metals' },
          { name: 'Glycol & Amine Buffer System',     function: 'Corrosion inhibition and pH buffering',                     percent: '8–10%',  compat: 'Aluminium, machine surfaces' },
          { name: 'Surfactant & Sequestrant Package', function: 'Emulsification, hard water stability, low foaming',        percent: '4–6%',   compat: 'All substrates' },
        ],
        application: [
          { step: '1', name: 'Charge Water',         param: 'Fill sump/tank with clean water first',          value: 'Per required dilution' },
          { step: '2', name: 'Add UNICUT-AL',        param: 'Add concentrate slowly to water with agitation', value: '3 – 8% v/v depending on operation' },
          { step: '3', name: 'Verify Concentration', param: 'Check with refractometer',                       value: 'General 5% · Heavy 7–8% · Grinding 3–4%' },
          { step: '4', name: 'Monitor & Maintain',   param: 'Check pH, concentration and top-up regularly',   value: 'Weekly during production' },
        ],
        packaging: [
          { size: '20',   unit: 'L', type: 'HDPE jerrycan' },
          { size: '210',  unit: 'L', type: 'MS drum' },
          { size: '1000', unit: 'L', type: 'IBC tote' },
        ],
        performance: [
          { label: 'Aluminium staining',   val: 'Very low — no visible staining at recommended dilution' },
          { label: 'Foam level',           val: 'Low, stable in high-pressure coolant systems' },
          { label: 'Sump life',            val: 'Extended — good emulsion stability, biocide compatible' },
          { label: 'Hard water stability', val: 'Stable emulsion across a wide range of water hardness' },
        ],
        safetyNote: 'Mildly alkaline (pH 9.2–9.6). Avoid prolonged skin contact; use recommended PPE. Refer to SDS-UCA-001.',
      },
    },
  },

  {
    productKey: 'unicut-al',
    docType:    'msds',
    docNumber:  'SDS-UCA-001',
    revision:   'Rev 01 — Jul 2026',
    footer: {
      left:   'SDS-UCA-001 Rev 01 · Jul 2026',
      center: 'This Safety Data Sheet is provided in good faith based on current knowledge. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nGHS Rev 9 Compliant · Page 1 of 1',
    },
    body: {
      ...
      sections: {
        identification: {
          productType:  'Semi-synthetic water-dilutable metalworking fluid (cutting & grinding coolant)',
          intendedUse:  'Machining, drilling, milling, turning and grinding of aluminium and aluminium alloys',
          manufacturer: 'Macro Coats Pvt Ltd, Chennai, Tamil Nadu, India',
          emergency:    'AIIMS Poison Control: 1800-11-6117 (Toll-Free)',
        },
        hazards: {
          ...
          hStatements: 'H315 — Causes skin irritation. H319 — Causes serious eye irritation. H412 — Harmful to aquatic life with long lasting effects.',
          pStatements: 'P264 · P273 · P280 · P302+P352 · P305+P351+P338 · P332+P313 · P337+P313',
        },
        composition: {
          ingredients: [
            { name: 'Deionised water',              description: 'Base carrier — major component',                            ghsClass: '—',              tagType: 'safe' },
            { name: 'Light paraffinic mineral oil', description: 'Boundary lubricant — reduces tool wear, improves finish',   ghsClass: 'Not classified', tagType: 'safe' },
            { name: 'Propylene glycol',             description: 'Co-solvent and humectant',                                   ghsClass: 'Not classified', tagType: 'safe' },
            { name: 'Triethanolamine (TEA)',        description: 'pH buffer and corrosion inhibitor',                          ghsClass: 'Irritant',       tagType: 'warn' },
            { name: 'Alcohol ethoxylate (LAE-7)',   description: 'Non-ionic emulsifying surfactant',                           ghsClass: 'Irritant',       tagType: 'warn' },
            { name: 'Sodium gluconate',             description: 'Sequestrant — hard water stability',                         ghsClass: '—',              tagType: 'safe' },
            { name: 'Borax',                        description: 'Corrosion inhibitor and buffering agent',                    ghsClass: 'Irritant',       tagType: 'warn' },
            { name: 'Non-silicone defoamer',        description: 'Foam control additive',                                       ghsClass: '—',              tagType: 'safe' },
          ],
          note: 'Exact formulation is proprietary. Functional ingredient descriptions are provided for safety and emergency purposes only.',
        },
        firstAid: {
          skin:       'Wash affected area with soap and plenty of water. Remove contaminated clothing. Seek medical advice if irritation persists.',
          eyes:       'Flush with running water for ≥15 min, holding eyelids open. Seek medical attention.',
          ingestion:  'Rinse mouth with water. Do NOT induce vomiting. Seek medical advice.',
          inhalation: 'Move to fresh air. If symptoms persist (e.g. from mist exposure during grinding), seek medical attention.',
          warning:    '⚠ Mildly alkaline — avoid prolonged or repeated skin contact.',
        },
        fireFighting: {
          flammability:       'Non-flammable, aqueous emulsion. Not classified as a fire hazard under normal use.',
          extinguishingMedia: 'CO₂, dry powder, foam, water spray — use media appropriate to surrounding fire.',
          fireHazard:         'Product itself will not burn readily; concentrated mineral oil component may support combustion at high temperature.',
          ppe:                'SCBA and standard fire-resistant clothing for surrounding fire.',
        },
        accidentalRelease: [
          'Contain spill to prevent entry into drains, waterways or soil',
          'Absorb with inert absorbent material (sand, vermiculite, sawdust)',
          'Floors may become slippery — clean promptly to avoid slip hazard',
          'Collect into suitable containers for disposal',
          'Dispose of collected material per CPCB/SPCB guidelines',
        ],
        handling: {
          handling:    'Avoid prolonged or repeated skin contact. Use in well-ventilated areas, particularly where mist is generated during grinding operations.',
          storageTemp: '5 °C – 40 °C; store indoors away from direct sunlight',
          containers:  'HDPE jerrycans, MS drums or IBC totes; keep tightly closed when not in use',
          segregation: 'Store separately from strong acids and strong oxidising agents',
          shelfLife:   '12 months from date of manufacture in original sealed containers',
        },
        exposure: {
          ppeItems:    ['Safety Glasses', 'Nitrile Gloves', 'Protective Apron', 'Safety Footwear'],
          engineering: 'Local exhaust/mist extraction at grinding and high-speed machining stations. Eyewash station within 10 s of handling area.',
        },
        physical: [
          { key: 'Appearance',       val: 'Milky white liquid' },
          { key: 'Odour',            val: 'Mild' },
          { key: 'pH (5% Emulsion)', val: '9.2 – 9.6' },
          { key: 'Specific Gravity', val: '0.98 – 1.02' },
          { key: 'Solubility',       val: 'Fully dilutable/miscible with water' },
          { key: 'Flash Point',      val: 'None (aqueous emulsion at working dilution)' },
        ],
        stability: {
          stability:      'Stable under recommended storage conditions.',
          avoid:          'Strong acids, strong oxidising agents, freezing temperatures (may break emulsion)',
          decomposition:  'Combustion may produce CO, CO₂, nitrogen oxides and boron oxides.',
          polymerisation: 'Will not occur',
        },
        sections11to16: {
          'Skin / Eye': 'Mild alkaline emulsion — may cause skin and eye irritation on repeated or prolonged contact. Flush with water if contact occurs.',
          Aquatic:      'H412 — harmful to aquatic life with long lasting effects. Avoid discharge to drains or watercourses.',
...

  {
    productKey: 'unicut-al',
    docType:    'formula',
    docNumber:  'FRM-UCA-001',
    revision:   'Rev 01 — Jul 2026',
    footer: {
      left:   'FRM-UCA-001 Rev 01 · Jul 2026',
      center: 'CONFIDENTIAL — This formulation sheet is the proprietary information of Macro Coats Pvt Ltd. Unauthorised reproduction or disclosure is prohibited.',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      ...
      referenceBatchSize: 25,
      batchUnit:          'L',
      totalActivePercent: 23.7,
      overview: 'UNICUT-AL is a semi-synthetic water-miscible cutting fluid for machining, drilling, milling, turning and grinding of aluminium and aluminium alloys, combining a light paraffinic mineral oil lubricity package with a glycol/amine buffer and gluconate/borax hard-water-stable inhibitor system.',
      composition: [
        { srNo: 1, name: 'DM Water',                        casNo: '7732-18-5', baseQty: null,  unit: 'L',  percentWV: null, function: 'Solvent base and heat-transfer carrier — balance to final batch volume (de-mineralised)', density: 1.0,   unitPrice: 0   },
        { srNo: 2, name: 'Light Paraffinic Mineral Oil',    casNo: '8012-95-1', baseQty: 2.000, unit: 'L',  percentWV: 8.0,  function: 'Boundary lubricant — reduces tool wear, improves surface finish and cooling-lubrication balance', density: 0.86,  unitPrice: 0   },
        { srNo: 3, name: 'Propylene Glycol',                casNo: '57-55-6',   baseQty: 1.250, unit: 'L',  percentWV: 5.0,  function: 'Co-solvent / humectant — improves low-temperature stability and lubricity',              density: 1.036, unitPrice: 0   },
        { srNo: 4, name: 'Triethanolamine (TEA)',           casNo: '102-71-6',  baseQty: 1.000, unit: 'L',  percentWV: 4.0,  function: 'pH buffer and corrosion inhibitor — maintains alkaline emulsion stability',              density: 1.124, unitPrice: 200 },
        { srNo: 5, name: 'Alcohol Ethoxylate (LAE-7)',       casNo: '9002-92-0', baseQty: 0.750, unit: 'L',  percentWV: 3.0,  function: 'Non-ionic emulsifying surfactant — stabilises oil-in-water emulsion, low foaming',       density: 0.95,  unitPrice: 0   },
        { srNo: 6, name: 'Sodium Gluconate',                casNo: '527-07-1',  baseQty: 0.500, unit: 'kg', percentWV: 2.0,  function: 'Sequestrant — hard water stability, prevents metal ion interference',                    density: 1.0,   unitPrice: 75  },
        { srNo: 7, name: 'Borax',                           casNo: '1303-96-4', baseQty: 0.375, unit: 'kg', percentWV: 1.5,  function: 'Corrosion inhibitor and alkalinity buffer',                                              density: 1.0,   unitPrice: 140 },
        { srNo: 8, name: 'Non Silicone Defoamer',           casNo: 'Mixture',   baseQty: 0.050, unit: 'L',  percentWV: 0.2,  function: 'Foam control additive — maintains low foam in high-pressure coolant systems',           density: 1.0,   unitPrice: 220 },
      ],
      preparation: [
        { step: 1, title: 'Safety Setup',              detail: 'Ensure working area is well-ventilated. Wear PPE: safety glasses, nitrile gloves, and protective apron. Avoid contact with eyes and skin.' },
        { step: 2, title: 'Charge DM Water',           detail: 'Add approximately 15 L (60%) of de-mineralised (DM) water to the mixing vessel and start agitation.' },
        { step: 3, title: 'Emulsify Mineral Oil',      detail: 'Pre-blend Light Paraffinic Mineral Oil with Alcohol Ethoxylate (LAE-7), then add slowly to the water under high-shear agitation to form a stable emulsion.' },
        { step: 4, title: 'Add Propylene Glycol & TEA', detail: 'Add Propylene Glycol and Triethanolamine (TEA) and mix until homogeneous; TEA raises pH into the alkaline buffer range.' },
        { step: 5, title: 'Add Sodium Gluconate & Borax', detail: 'Pre-dissolve Sodium Gluconate and Borax in a small quantity of warm DM water, then blend into the main batch with continued agitation.' },
        { step: 6, title: 'Add Defoamer',              detail: 'Add Non Silicone Defoamer and mix gently to avoid introducing air into the emulsion.' },
        { step: 7, title: 'Final Volume Adjustment',   detail: 'Top up with remaining DM water to bring the final batch volume to exactly 25 L. Stir for 10 minutes to ensure homogeneity.' },
        { step: 8, title: 'QC Check & Fill',           detail: 'Check pH (target 9.2–9.6) and appearance (milky white liquid). Verify 5% emulsion stability. Fill into labelled containers.' },
      ],
      operatingConditions: [
        { param: 'Mixing Temperature',       value: 'Ambient (25 – 35 °C)' },
        { param: 'Agitation',                value: 'High shear during oil emulsification, moderate thereafter' },
        { param: 'Working Dilution',         value: '3 – 8% v/v depending on operation' },
        { param: 'pH (5% Emulsion)',         value: '9.2 – 9.6' },
        { param: 'Substrate Compatibility',  value: 'Aluminium and aluminium alloys' },
      ],
      applications: {
        removes:    ['Machining heat', 'Metal chips & swarf', 'Frictional heat build-up', 'Built-up edge (BUE) risk'],
        usedBefore: ['Precision inspection & measurement', 'Assembly operations', 'Anodizing / surface finishing', 'Packaging & dispatch'],
      },
    },
  },

  {
    ...
    body: {
      ...
      pCodes: [
        ...
        { code: 'P273',            text: 'Avoid release to the environment' },
        { code: 'P280',            text: 'Wear protective gloves and eye protection' },
        { code: 'P302+P352',       text: 'If on skin, wash with plenty of soap and water' },
        { code: 'P305+P351+P338', text: 'If in eyes, rinse cautiously with water for several minutes' },
        { code: 'P332+P313',       text: 'If skin irritation occurs, get medical advice' },
      ],
      firstAid: {
        skin:       'Wash with soap and water. Remove contaminated clothing.',
        eyes:       'Flush with running water for ≥15 min. Seek medical attention.',
      ...
      directions: [
        'Dilute with water at 3–8% concentrate depending on operation (General 5% · Heavy 7–8% · Grinding 3–4%)',
        'Add concentrate to water; verify concentration with refractometer',
        'Maintain concentration and monitor sump condition regularly',
        'Suitable for CNC, VMC, turning, milling, drilling and grinding of aluminium components',
      ],
      storage:  ['Store indoors away from direct sunlight', 'Store at 5°C – 40°C', 'Keep container tightly closed', 'Dispose per CPCB regulations'],
      products: ['UNICUT-AL'],
    },
  },

  {
    productKey: 'unicut-al',
    docType:    'coa',
    docNumber:  'COA-UCA-001',
    revision:   'Rev 01 — Jul 2026',
    footer: {
      left:   'COA-UCA-001 Rev 01 · Jul 2026',
      center: 'CONFIDENTIAL — For authorised recipients only · Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India',
    },
    body: {
      batchNumber:    'UCA-20260721-001',
      batchSize:      '25 L',
      productionDate: '21 Jul 2026',
      expiryDate:     'Jul 2027',
      grade:          'Industrial Grade — Water Dilutable Metalworking Fluid',
      appearance:     'Milky White Liquid',
      tests: [
        { parameter: 'Appearance',                            method: 'Visual',                       specification: 'Milky white liquid',       result: 'Milky white liquid',             status: 'Pass' },
        { parameter: 'Colour',                                method: 'Visual',                       specification: 'Milky white',               result: 'Milky white',                    status: 'Pass' },
        { parameter: 'Odour',                                 method: 'Olfactory',                    specification: 'Mild',                      result: 'Mild',                           status: 'Pass' },
        { parameter: 'pH (5% Emulsion, 25 °C)',               method: 'pH Electrode',                 specification: '9.2 – 9.6',                 result: '9.4',                             status: 'Pass' },
        { parameter: 'Specific Gravity (25 °C)',              method: 'ISO 2811',                     specification: '0.98 – 1.02',               result: '1.00',                            status: 'Pass' },
        { parameter: 'Emulsion Stability (5%, 24 h)',         method: 'Internal IM-004',              specification: 'No separation / creaming',  result: 'Stable, no separation observed', status: 'Pass' },
        { parameter: 'Foam Level (5%, agitated)',             method: 'DIN 51566',                    specification: 'Low, dissipates < 30 s',    result: '18 s',                            status: 'Pass' },
        { parameter: 'Aluminium Staining (24 h immersion)',   method: 'Internal IM-005',               specification: 'No staining',               result: 'No staining observed',           status: 'Pass' },
        { parameter: 'Corrosion Protection (Cast Iron Chip)', method: 'IP 287 / Herbert Chip Test',   specification: 'No corrosion, Rating 0',    result: 'Rating 0 — no corrosion',        status: 'Pass' },
      ],
      statement: 'We hereby certify that the above batch of UNICUT-AL has been manufactured, tested, and inspected in accordance with our internal quality specifications. All parameters conform to the product specification and the product is approved for release.',
      approvals: {
        preparedBy: 'Quality Analyst — Macro Coats',
        reviewedBy: 'QC Manager — Macro Coats',
        approvedBy: 'Operations Head — Macro Coats',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // UNIKLEAN-CU — placeholder documents (draft). No formulation/spec data
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    productKey: 'uniklean-cu',
    docType:    'tds',
    docNumber:  'TDS-CU-001',
    revision:   'Rev 01 — Aug 2026',
    status:     'draft',
    footer: {
      left:   'TDS-CU-001 Rev 01 · Aug 2026',
      center: 'This Technical Data Sheet is for guidance only. Performance figures are typical values obtained under controlled conditions. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
      grade:       'Industrial Grade — Alkaline Cleaning Concentrate',
      description: 'UNIKLEAN-CU is an industrial alkaline cleaning concentrate formulated with an alkalinity builder, a hard-water sequestrant, a non-ionic surfactant wetting/degreasing package, coupling solvents for oil and grease solvency, and a corrosion inhibitor, in a water carrier.',
      sections: {
        features: [
          { head: 'Alkaline Cleaning Action',     body: 'Alkalinity builder provides effective degreasing and soil-removal power.' },
          { head: 'Hard Water Compatible',         body: 'Sequestrant system maintains cleaning performance across a range of water hardness.' },
          { head: 'Balanced Wetting & Degreasing', body: 'Non-ionic surfactant package aids wetting, emulsification and soil removal.' },
          { head: 'Enhanced Grease/Oil Solvency',  body: 'Coupling solvents improve penetration and solvency of oily/greasy soils.' },
        ...
        composition: [
          { name: 'Carrier / solvent',                                  function: 'Aqueous carrier / base medium',                     percent: '50–70%', compat: 'All metals' },
          { name: 'Alkalinity builder',                                 function: 'Alkalinity builder and buffering',                   percent: '5–10%',  compat: 'Ferrous and non-ferrous metals' },
          { name: 'Chelating agent',                                    function: 'Chelating agent for hardness control',               percent: '2–5%',   compat: 'Hard and soft water' },
          { name: 'Non-ionic surfactant — wetting and degreasing agent', function: 'Wetting & degreasing agent — non-ionic surfactant', percent: '5–10%',  compat: 'All metals' },
          { name: 'Non-ionic surfactant — wetting and degreasing agent', function: 'Wetting & degreasing agent — non-ionic surfactant', percent: '2–5%',   compat: 'All metals' },
          { name: 'Glycol ether coupling solvent',                      function: 'Coupling solvent — improves oil/grease solvency',    percent: '5–10%',  compat: '—' },
        ...
        performance: [
          { label: 'Degreasing / Cleaning Performance', val: 'Expected — alkalinity builder + surfactant package designed for effective oil/grease removal (not yet lab-validated)' },
          { label: 'Hard Water Performance',            val: 'Expected — sequestrant system designed to maintain performance across water hardness (not yet lab-validated)' },
          { label: 'Corrosion Protection',               val: 'Expected — corrosion inhibitor included in formulation (not yet lab-validated)' },
          { label: 'Foaming Characteristics',            val: 'Not yet characterized — pending lab testing' },
        ],
        safetyNote: 'DANGER — contains a flammable component (H226) and irritant/corrosive-classified ingredients. Refer to SDS-CU-001 for full hazard information before handling.',
      },
    },
  },

  {
    productKey: 'uniklean-cu',
    docType:    'msds',
    docNumber:  'SDS-CU-001',
    revision:   'Rev 01 — Aug 2026',
    status:     'draft',
    footer: {
      left:   'SDS-CU-001 Rev 01 · Aug 2026',
      center: 'This Safety Data Sheet is provided in good faith based on current knowledge. © Macro Coats Pvt Ltd',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nGHS Rev 9 Compliant · Page 1 of 1',
    },
    body: {
      ...
      sections: {
        identification: {
          productType:  'Aqueous alkaline cleaning concentrate',
          intendedUse:  'Industrial degreasing and surface cleaning of metal components',
          manufacturer: 'Macro Coats Pvt Ltd, Chennai, Tamil Nadu, India',
          emergency:    'AIIMS Poison Control: 1800-11-6117 (Toll-Free)',
        },
        hazards: {
          pictograms:      ['irritant', 'corrosive', 'environment', 'flammable'],
          classifications: [
            { class: 'Serious Eye Damage',                                  category: 'Cat 2', tagType: 'warn' },
            { class: 'Serious Eye Damage',                                  category: 'Cat 1', tagType: 'danger' },
            { class: 'Aquatic Toxicity (Chronic)',                          category: 'Cat 3', tagType: 'warn' },
            { class: 'Acute Toxicity (Oral)',                               category: 'Cat 4', tagType: 'warn' },
            { class: 'Skin Irritation',                                     category: 'Cat 2', tagType: 'warn' },
            { class: 'Serious Eye Irritation',                              category: 'Cat 2', tagType: 'warn' },
            { class: 'Specific Target Organ Toxicity — Single Exposure',    category: 'Cat 3', tagType: 'warn' },
            { class: 'Flammable Liquid',                                    category: 'Cat 3', tagType: 'warn' },
          ],
          hStatements: 'H319 — Causes serious eye irritation. H318 — Causes serious eye damage. H412 — Harmful to aquatic life with long lasting effects. H302 — Harmful if swallowed. H315 — Causes skin irritation. H335 — May cause respiratory irritation. H226 — Flammable liquid and vapour.',
          pStatements: 'P264 · P280 · P305+P351+P338 · P337+P313 · P310 · P273 · P270 · P301+P312 · P302+P352 · P332+P313 · P261 · P271 · P304+P340 · P210 · P233 · P240 · P241 · P242 · P243',
        },
        composition: {
          ingredients: [
            { name: 'Alkalinity builder',            description: 'Alkalinity builder',            percent: '5–10%',  ghsClass: 'Serious Eye Damage',    tagType: 'warn' },
            { name: 'Glycol ether coupling solvent',  description: 'Glycol ether coupling solvent', percent: '5–10%',  ghsClass: 'Acute Toxicity (Oral)', tagType: 'warn' },
            { name: 'Proprietary Chemical Blend',     description: 'Blend of non-hazardous or below-threshold proprietary ingredients', percent: '70–90%', ghsClass: '—', tagType: 'safe' },
          ],
          note: 'Exact formulation is proprietary. Functional ingredient descriptions are provided for safety and emergency purposes only.',
        },
        firstAid: {
          skin:       'Remove contaminated clothing. Wash affected area with plenty of soap and water. Seek medical attention if irritation persists.',
          eyes:       'Rinse cautiously with water for several minutes. Remove contact lenses if present and easy to do. Continue rinsing. Seek immediate medical attention.',
        ...
        fireFighting: {
          flammability:       'Contains a flammable component (H226). The aqueous concentrate itself is not readily flammable, but may support combustion near an ignition source; vapours may be flammable.',
          extinguishingMedia: 'CO₂, dry chemical powder, foam, or water spray/fog — use media appropriate to the surrounding fire.',
          fireHazard:         'May release irritating/toxic fumes (carbon oxides) on combustion. Keep away from heat, sparks and open flame.',
          ppe:                'Self-contained breathing apparatus (SCBA) and full protective/fire-resistant clothing for firefighters.',
        },
        accidentalRelease: [
          'Evacuate non-essential personnel and eliminate ignition sources',
          'Wear appropriate PPE (gloves, eye protection) before attempting cleanup',
          'Contain spill to prevent entry into drains, waterways or soil',
          'Absorb with inert absorbent material (sand, vermiculite, sawdust)',
          'Collect into suitable containers for disposal',
          'Dispose of collected material per CPCB/SPCB guidelines',
        ...
        handling: {
          handling:    'Avoid contact with skin and eyes. Avoid breathing vapours/mist. Keep away from heat, sparks and open flame. Use in a well-ventilated area.',
          storageTemp: '5 °C – 40 °C; store indoors away from direct sunlight and ignition sources',
          containers:  'HDPE jerrycans, MS drums or IBC totes; keep tightly closed when not in use',
          segregation: 'Store separately from strong oxidising agents and away from open flame/ignition sources',
          shelfLife:   '12 months from date of manufacture in original sealed containers — generic default, confirm against QA stability data once available',
        },
        exposure: {
          ppeItems:    ['Safety Glasses / Face Shield', 'Nitrile Gloves', 'Protective Apron', 'Respirator if vapours exceed exposure limits'],
        ...
        stability: {
          stability:      'Stable under recommended storage conditions.',
          avoid:          'Strong oxidising agents, open flame, sources of ignition, extreme temperatures',
          decomposition:  'Combustion may produce carbon oxides and other irritating/toxic fumes.',
          polymerisation: 'Will not occur',
        },
        sections11to16: {
          'Skin / Eye': 'May cause skin and eye irritation/damage on contact — flush with water if contact occurs, per First Aid section.',
          Aquatic:      'H412 — harmful to aquatic life with long lasting effects. Avoid discharge to drains or watercourses.',
          Disposal:     'Do not discharge undiluted product to drains. Dispose of via licensed waste contractor per CPCB/SPCB norms (E.P. Act 1986).',
          Regulatory:   'MSIHC Rules 1989 · Factories Act 1948 · Hazardous Waste Rules 2016 · GHS Rev 9',
          'Other Info': 'SDS Rev 01 issued Aug 2026. Next review: Aug 2028 or upon formulation change.',
        },
      },
    },
  },

  {
    productKey: 'uniklean-cu',
    docType:    'formula',
    docNumber:  'FRM-CU-001',
    revision:   'Rev 01 — Aug 2026',
    status:     'pending_review',
    footer: {
      left:   'FRM-CU-001 Rev 01 · Aug 2026',
      center: 'CONFIDENTIAL — This formulation sheet is the proprietary information of Macro Coats Pvt Ltd. Unauthorised reproduction or disclosure is prohibited.',
      right:  'Macro Coats Pvt Ltd · Chennai · India\nPage 1 of 1',
    },
    body: {
...

  {
    ...
    body: {
      ...
      pCodes: [
        ...
        { code: 'P233',            text: 'Keep container tightly closed.' },
        { code: 'P240',            text: 'Ground/bond container and receiving equipment.' },
        { code: 'P241',            text: 'Use explosion-proof electrical/ventilating/lighting equipment.' },
        { code: 'P242',            text: 'Use only non-sparking tools.' },
        { code: 'P243',            text: 'Take precautionary measures against static discharge.' },
      ],
      firstAid: {
        skin:       'Remove contaminated clothing. Wash affected area with plenty of soap and water. Seek medical attention if irritation persists.',
        eyes:       'Rinse cautiously with water for several minutes. Remove contact lenses if present and easy to do. Continue rinsing. Seek immediate medical attention.',
      ...
      directions: [
        'For industrial use only — dilute with water to the working concentration required for the application before use.',
        'Do not use undiluted unless the process specification requires it.',
        'Apply by immersion, spray or wipe application as appropriate to the process.',
        'Use only in a well-ventilated area, away from heat, sparks and open flame (see SDS-CU-001).',
...

  {
    productKey: 'uniklean-cu',
    docType:    'coa',
    docNumber:  'COA-CU-001',
    revision:   'Draft — pending formulation data',
    status:     'draft',
    footer: {
      left:   'COA-CU-001 Draft',

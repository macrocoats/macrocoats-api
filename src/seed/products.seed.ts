...
const DOCS: Array<{
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    body: {
      grade:       'Industrial Grade',
      description: 'CORROKLEAN is a heavy-duty, water-based alkaline cleaning concentrate formulated for the removal of oils, greases, metal fines, and general industrial soils from ferrous and non-ferrous substrates. Combining a synergistic blend of alkaline builders, a chelating agent, and a low-foam nonionic surfactant, it delivers fast, reliable cleaning at low working concentrations in spray wash, immersion, and ultrasonic cleaning systems. The formulation is non-flammable and produces a corrosion-inhibited surface after treatment.',
      sections: {
        features: [
          { head: 'Multi-builder Alkalinity',   body: 'Balanced alkaline builder system delivers high cleaning power against stubborn oils, drawing compounds, and metal soils at low concentration' },
          { head: 'Chelated Hardness Control',  body: 'Sequestering agent prevents calcium/magnesium scaling in hard-water areas, extending bath life and preventing residue on cleaned parts' },
          { head: 'Low-Foam Performance',       body: 'Low-foam nonionic surfactant system compatible with high-pressure spray wash and agitated immersion processes' },
          { head: 'Multi-metal Safe',           body: 'Suitable for mild steel, cast iron, galvanised, and aluminium substrates at recommended working concentrations' },
        ],
        physicalProperties: [
          { property: 'Appearance',             value: 'Clear to pale straw liquid',  unit: '—',     method: 'Visual' },
          { property: 'pH (neat)',              value: '11.5 – 12.5',                 unit: '—',     method: 'pH electrode, 25 °C' },
          { property: 'pH (2% solution)',       value: '9.5 – 11.0',                  unit: '—',     method: 'pH electrode, 25 °C' },
          { property: 'Density',               value: '~1.03 – 1.06',                unit: 'g/mL',  method: 'ISO 2811' },
          { property: 'Flash Point',           value: 'None',                        unit: '—',     method: 'Aqueous solution' },
          { property: 'Working Concentration', value: '2 – 5',                       unit: '% v/v', method: 'Titration / pH control' },
          { property: 'Working Temperature',   value: '40 – 65',                     unit: '°C',    method: '—' },
          { property: 'Contact Time',          value: '3 – 15',                      unit: 'min',   method: 'Process qualification' },
        ],
        composition: [
          { name: 'Alkaline silicate builder',        function: 'Primary alkalinity source — saponification, metal conditioning and corrosion inhibition', percent: '—', compat: 'Ferrous, Al at working dilution' },
          { name: 'Alkaline carbonate builder',       function: 'pH buffer and supplementary alkalinity — oil emulsification and mild abrasive action',    percent: '—', compat: 'All metals at working dilution' },
          { name: 'Phosphate / phosphate-free builder', function: 'Builder for heavy grease removal and water softening',                                  percent: '—', compat: 'All metals' },
          { name: 'Nonionic surfactant',              function: 'Oil emulsification, wetting and low-foam detergency',                                     percent: '—', compat: 'Low foam at ≤65 °C' },
          { name: 'Sequestering / chelating agent',   function: 'Water hardness control — prevents scaling and extends bath life',                         percent: '—', compat: 'Hard and soft water' },
          { name: 'Water',                            function: 'Carrier / solvent',                                                                       percent: '—', compat: '—' },
        ],
        application: [
          { step: '1', name: 'Prepare bath',    param: '2–5% CORROKLEAN in water',               value: '40–65 °C' },
          { step: '2', name: 'Load parts',      param: 'Dip or spray',                            value: '3–15 min contact' },
          { step: '3', name: 'First rinse',     param: 'Tap water overflow rinse',                value: 'Ambient, 1–2 min' },
          { step: '4', name: 'Second rinse',    param: 'DI water rinse (if DI line available)',   value: 'Ambient' },
          { step: '5', name: 'Next stage',      param: 'Phosphating / corrosion protection / topcoat', value: 'As required' },
        ],
        packaging: [
          { size: '35', unit: 'L', type: 'HDPE jerrycan' },
          { size: '50', unit: 'L', type: 'HDPE jerrycan' },
        ...
        performance: [
          { label: 'Oil removal (mineral oil)',  val: '> 99% at 3%, 55 °C, 5 min' },
          { label: 'Foam (spray, 55 °C)',        val: '< 5 mL (DIN 53902)' },
          { label: 'Flash rust protection',      val: 'No flash rust ≥ 2 h post-clean (IS 5521)' },
          { label: 'Bath life',                  val: '5–7 shifts at 3% with top-up' },
        ],
        safetyNote: 'Corrosive at full concentration — always dilute before use. Refer to the current SDS (SDS-UCK-001) for full hazard information and PPE requirements.',
      },
    },
  },

  {
    ...
    body: {
      ...
      sections: {
        identification: {
          productType:  'Aqueous alkaline metal cleaning and degreasing concentrate',
          intendedUse:  'Industrial degreasing and pre-treatment cleaning of ferrous and non-ferrous metal substrates; applied by dip or spray',
          manufacturer: 'Macro Coats Pvt Ltd, Chennai, Tamil Nadu, India',
          emergency:    'AIIMS Poison Control: 1800-11-6117 (Toll-Free)',
        },
        hazards: {
        ...
        composition: {
          ingredients: [
            { name: 'Alkaline silicate builder',          description: 'Alkalinity source — saponification and metal conditioning',           percent: '—', ghsClass: 'Corrosive', tagType: 'danger' },
            { name: 'Alkaline carbonate builder',         description: 'pH buffer and supplementary alkalinity',                              percent: '—', ghsClass: 'Irritant',  tagType: 'warn'   },
            { name: 'Phosphate / phosphate-free builder', description: 'Heavy soil removal and water softening agent',                        percent: '—', ghsClass: 'None',      tagType: 'safe'   },
            { name: 'Nonionic surfactant',                description: 'Low-foam oil emulsification and wetting agent',                       percent: '—', ghsClass: 'Irritant',  tagType: 'warn'   },
            { name: 'Sequestering / chelating agent',     description: 'Water hardness control — prevents scale formation in bath',           percent: '—', ghsClass: 'None',      tagType: 'safe'   },
            { name: 'Water',                              description: 'Carrier / solvent',                                                   percent: '—', ghsClass: '—',         tagType: 'safe'   },
          ],
          note: 'Exact formulation is proprietary. Functional ingredient descriptions are provided for safety and emergency purposes only.',
        },
        firstAid: {
        ...
        accidentalRelease: [
          ...
          'Contain spill with sand or vermiculite; avoid runoff to drains',
          'Neutralise with dilute acid (citric or acetic) before disposal',
          'Prevent entry into waterways — harmful to aquatic organisms',
          'Dispose as per local CPCB/SPCB guidelines',
        ],
        handling: {
          handling:     'Apply by dip or spray. Dilute concentrate carefully — always add to water, not vice versa. Handle in well-ventilated areas.',
          storageTemp:  '10 °C – 35 °C; cool, dry place; protect from frost',
          containers:   'Sealed HDPE or polypropylene containers; segregate from acids',
          segregation:  'Store separately from acids, ammonium salts, and oxidising agents',
          shelfLife:    '24 months from date of manufacture (sealed, stored correctly)',
        },
        ...
        physical: [
          ...
          { key: 'Odour',         val: 'Mild, characteristic' },
          { key: 'pH (neat)',     val: '11.5 – 12.5' },
          { key: 'Density',       val: '~1.03 – 1.06 g/mL' },
          { key: 'Flash Point',   val: 'None (aqueous)' },
          { key: 'Boiling Point', val: '~101 °C' },
          { key: 'Solubility',    val: 'Fully miscible with water' },
          { key: 'Viscosity',     val: 'Low (water-like)' },
        ...
        sections11to16: {
          'Skin / Eye': 'Alkaline burns — corrosive to skin and eyes at full concentration. Diluted solutions are irritating.',
          Aquatic:      'H412 — surfactants and alkali builders harmful to aquatic life with long lasting effects',
          Disposal:     'Neutralise to pH 6–9 before discharge. Dispose per CPCB/SPCB norms (E.P. Act 1986)',
          Regulatory:   'MSIHC Rules 1989 · Factories Act 1948 · Hazardous Waste Rules 2016 · GHS Rev 9',
...

  {
    ...
    body: {
      ...
      referenceBatchSize: 100,
      batchUnit:          'L',
      totalActivePercent: 11.75,
      overview: 'CORROKLEAN is a concentrated aqueous alkaline cleaner formulated with a silicate–carbonate–phosphate builder system, a low-foam nonionic surfactant, and sodium gluconate as a chelating/sequestering agent. The product delivers effective oil and grease removal with hard water stability.',
      composition: [
        { srNo: 1, name: 'Sodium Metasilicate Pentahydrate',            casNo: '10213-79-3', baseQty: 4.0,  unit: 'kg', percentWV: 4.0,  function: 'Primary alkalinity source — saponification of oils, metal conditioning, flash rust inhibition', density: null, unitPrice: 38  },
        { srNo: 2, name: 'Soda Ash (Sodium Carbonate)',                 casNo: '497-19-8',   baseQty: 3.0,  unit: 'kg', percentWV: 3.0,  function: 'pH buffer and supplementary alkalinity builder',                                              density: null, unitPrice: 14  },
        { srNo: 3, name: 'Trisodium Phosphate (TSP)',                   casNo: '7601-54-9',  baseQty: 3.0,  unit: 'kg', percentWV: 3.0,  function: 'Builder — heavy grease and soil removal, water softening',                                     density: null, unitPrice: 42  },
        { srNo: 4, name: 'Nonionic Surfactant (LAE-9)',                 casNo: '9002-92-0',  baseQty: 1.0,  unit: 'kg', percentWV: 1.0,  function: 'Low-foam oil emulsification, wetting and detergency',                                         density: null, unitPrice: 380 },
        { srNo: 5, name: 'Sodium Gluconate',                            casNo: '527-07-1',   baseQty: 0.75, unit: 'kg', percentWV: 0.75, function: 'Chelating and sequestering agent — water hardness control, bath life extension',               density: null, unitPrice: 95  },
        { srNo: 6, name: 'Water',                                       casNo: '7732-18-5',  baseQty: null, unit: 'L',  percentWV: null, function: 'Carrier / solvent — balance to final volume',                                               density: null, unitPrice: 0   },
      ],
      preparation: [
        { step: 1, title: 'Water Charging',             detail: 'Add 60–65% of the required water (60–65 L for a 100 L batch) to the mixing vessel. Start agitation.' },
        { step: 2, title: 'Dissolve Silicate Builder',  detail: 'Add 4 kg Sodium Metasilicate Pentahydrate slowly with stirring. Allow complete dissolution before the next addition.' },
        { step: 3, title: 'Dissolve Carbonate Builder', detail: 'Add 3 kg Soda Ash and mix until fully dissolved.' },
        { step: 4, title: 'Dissolve Phosphate Builder', detail: 'Add 3 kg Trisodium Phosphate and mix until fully dissolved.' },
        { step: 5, title: 'Add Chelating Agent',        detail: 'Add 0.75 kg Sodium Gluconate and mix until fully dissolved.' },
        { step: 6, title: 'Add Surfactant',             detail: 'Slowly add 1 kg LAE-9 nonionic surfactant while stirring to prevent foaming.' },
        { step: 7, title: 'Final Volume Adjustment',    detail: 'Add water to reach the final batch volume of 100 L and mix for 10–15 minutes.' },
        { step: 8, title: 'QC Check & Pack',            detail: 'Verify pH (neat: 11.5–12.5), appearance (clear to pale straw), and foam (minimal). Fill into labelled HDPE containers.' },
      ],
      operatingConditions: [
        { param: 'Bath Concentration',    value: '2 – 5 %' },
        { param: 'Operating Temperature', value: '40 – 65 °C' },
        { param: 'Bath pH',               value: '9.5 – 11.0 (at 2–5% working dilution)' },
        { param: 'Treatment Time',        value: '3 – 15 minutes' },
        { param: 'Application Method',    value: 'Spray wash or immersion' },
      ],
      applications: {
        removes:    ['Machining oils', 'Drawing compounds', 'Greases', 'Metal fines', 'General industrial soils'],
        usedBefore: ['Phosphating', 'Corrosion protection', 'Powder coating', 'Painting / liquid coat'],
      },
    },
  },

  {
    ...
    body: {
      ...
      directions: [
        'Dilute 2–5% in water before use',
        'Apply at 40–65 °C by spray or immersion',
        'Allow 3–15 min contact time',
        'Rinse thoroughly with clean water',
      ],
      storage:  ['Store at 10°C – 35°C', 'Keep away from sunlight and frost', 'Keep away from children', 'Dispose per local regulations (CPCB)'],
      products: ['CORROKLEAN', 'CORROKLEAN PLUS', 'CORROKLEAN NEUTRAL'],
    },
  },

  {
    ...
    body: {
      ...
      tests: [
        { parameter: 'Appearance',                    method: 'Visual',              specification: 'Clear to pale straw liquid',         result: 'Clear, pale straw liquid',       status: 'Pass' },
        { parameter: 'pH (neat, 25 °C)',              method: 'pH Electrode',        specification: '11.5 – 12.5',                        result: '12.0',                           status: 'Pass' },
        { parameter: 'pH (2% solution, 25 °C)',       method: 'pH Electrode',        specification: '9.5 – 11.0',                         result: '10.3',                           status: 'Pass' },
        { parameter: 'Specific Gravity (25 °C)',       method: 'ISO 2811',            specification: '1.03 – 1.06',                        result: '1.04',                           status: 'Pass' },
        { parameter: 'Total Alkalinity',              method: 'HCl Titration',       specification: '≥ 6.0 % (as Na₂O)',                  result: '7.1 %',                          status: 'Pass' },
        { parameter: 'Foam Level (spray, 55 °C)',     method: 'DIN 53902',           specification: '< 5 mL',                             result: '3 mL',                           status: 'Pass' },
        { parameter: 'Oil Removal Efficiency',        method: 'Internal IM-001',     specification: '≥ 98 %',                             result: '99.1 %',                         status: 'Pass' },
      ],
